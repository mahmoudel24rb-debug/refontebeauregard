...
const PAIRS = [
  ...
  [`Speed &amp; Agility Tracks`, `Kid Fitness`],
  [`Functional Training Areas`, `Yoga & Pilates`],
...
const FILE = 'src/components/sportix/HomePage.tsx'
...
console.log(`HomePage.tsx : ${n} remplacements appliqués`)
