                ...
                <div className={"framer-jkzr21"} data-framer-name={"Title Wrapper"} style={{ willChange: "auto", opacity: "1", transform: "none" }}>
                  ...
                  <div className={"framer-182phnk"} data-framer-name={"Author Info Wrapper"}>
                    <div className={"framer-1mclr9f"} data-framer-name={"Avatar"}>
                      <div style={{ position: "absolute", borderRadius: "inherit", cornerShape: "inherit", top: "0", right: "0", bottom: "0", left: "0" }}>
                        <img decoding={"async"} width={"1333"} height={"2000"} sizes={"(min-width: 1280px) 46px, (min-width: 992px) and (max-width: 1279px) 46px, (max-width: 991px) 46px"} srcSet={"/assets/beauregard/cardio.webp"} src={"/assets/beauregard/cardio.webp"} alt={"Avatar"} style={{ display: "block", width: "100%", height: "100%", borderRadius: "inherit", cornerShape: "inherit", objectPosition: "46.3% 35.7%", objectFit: "cover" }} />
                      </div>
                    </div>
                ...
                <div className={"framer-xae783"} data-framer-name={"Inneer Banner Wrapper"} style={{ willChange: "transform", opacity: "1", transform: "none" }}>
                  <div className={"ssr-variant"}>
                    <div className={"framer-1lgvd6o"}>
                      <div style={{ position: "absolute", borderRadius: "inherit", cornerShape: "inherit", top: "0", right: "0", bottom: "0", left: "0" }}>
                        <img decoding={"async"} width={"3000"} height={"2000"} sizes={"(min-width: 1280px) calc(min(100vw - 40px, 1320px) - 60px), (max-width: 991px) calc(min(100vw - 40px, 1320px) - 44px), (min-width: 992px) and (max-width: 1279px) calc(min(100vw - 40px, 1320px) - 40px)"} srcSet={"/assets/beauregard/fonctionnel.webp"} src={"/assets/beauregard/fonctionnel.webp"} alt={"Thumbnail"} style={{ display: "block", width: "100%", height: "100%", borderRadius: "inherit", cornerShape: "inherit", objectPosition: "69.3% 34.3%", objectFit: "cover" }} />
                      </div>
                    </div>
                  </div>
                </div>
                        ...
                        <a className={"framer-heWyC framer-Suf9V framer-80BYq framer-1rq5pk0 framer-v-1rq5pk0 framer-16a88ct"} data-framer-name={"Default"} style={{ width: "100%", borderBottomLeftRadius: "10px", borderBottomRightRadius: "10px", borderTopLeftRadius: "10px", borderTopRightRadius: "10px" }} href={"./high-intensity-workouts-vs-steady-state-cardio"}>
                          ...
                          <div className={"framer-1malnge"} data-framer-name={"Thumbnail"} style={{ borderBottomLeftRadius: "10px", borderBottomRightRadius: "10px" }}>
                            <div className={"framer-15v64hc"} style={{ transform: "none" }}>
                              <div style={{ position: "absolute", borderRadius: "inherit", cornerShape: "inherit", top: "0", right: "0", bottom: "0", left: "0" }}>
                                <img decoding={"async"} width={"2880"} height={"1920"} sizes={"(min-width: 1280px) max(max(min(max(100vw - 40px, 1px), 1320px) - 60px, 370px), 1px), (min-width: 992px) and (max-width: 1279px) max(max(min(max(100vw - 40px, 1px), 1320px) - 40px, 300px), 1px), (max-width: 991px) max(max(min(max(100vw - 40px, 1px), 1320px) - 40px, 280px), 1px)"} srcSet={"/assets/beauregard/location.webp"} src={"/assets/beauregard/location.webp"} alt={"Thumbnail"} style={{ display: "block", width: "100%", height: "100%", borderRadius: "inherit", cornerShape: "inherit", objectPosition: "22.8% 69.1%", objectFit: "cover" }} />
                              </div>
                            </div>
                          </div>
                        </a>
                      ...
                      <div className={"framer-tg2q6w-container"} style={{ willChange: "auto", opacity: "1", transform: "none" }}>
                        <a className={"framer-heWyC framer-Suf9V framer-80BYq framer-1rq5pk0 framer-v-1rq5pk0 framer-16a88ct"} data-framer-name={"Default"} style={{ width: "100%", borderBottomLeftRadius: "10px", borderBottomRightRadius: "10px", borderTopLeftRadius: "10px", borderTopRightRadius: "10px" }} href={"./what-to-eat-before-and-after-a-workout"}>
                          ...
                          <div className={"framer-1malnge"} data-framer-name={"Thumbnail"} style={{ borderBottomLeftRadius: "10px", borderBottomRightRadius: "10px" }}>
                            <div className={"framer-15v64hc"} style={{ transform: "none" }}>
                              <div style={{ position: "absolute", borderRadius: "inherit", cornerShape: "inherit", top: "0", right: "0", bottom: "0", left: "0" }}>
                                <img decoding={"async"} width={"2880"} height={"1839"} sizes={"(min-width: 1280px) max(max(min(max(100vw - 40px, 1px), 1320px) - 60px, 370px), 1px), (min-width: 992px) and (max-width: 1279px) max(max(min(max(100vw - 40px, 1px), 1320px) - 40px, 300px), 1px), (max-width: 991px) max(max(min(max(100vw - 40px, 1px), 1320px) - 40px, 280px), 1px)"} srcSet={"/assets/beauregard/nature.webp"} src={"/assets/beauregard/nature.webp"} alt={"Thumbnail"} style={{ display: "block", width: "100%", height: "100%", borderRadius: "inherit", cornerShape: "inherit", objectPosition: "center", objectFit: "cover" }} />
                              </div>
                            </div>
                          </div>
                        </a>
                      ...
                      <div className={"framer-tg2q6w-container"} style={{ willChange: "auto", opacity: "1", transform: "none" }}>
                        <a className={"framer-heWyC framer-Suf9V framer-80BYq framer-1rq5pk0 framer-v-1rq5pk0 framer-16a88ct"} data-framer-name={"Default"} style={{ width: "100%", borderBottomLeftRadius: "10px", borderBottomRightRadius: "10px", borderTopLeftRadius: "10px", borderTopRightRadius: "10px" }} href={"./tips-for-long-lasting-performance"}>
                          ...
                          <div className={"framer-1malnge"} data-framer-name={"Thumbnail"} style={{ borderBottomLeftRadius: "10px", borderBottomRightRadius: "10px" }}>
                            <div className={"framer-15v64hc"} style={{ transform: "none" }}>
                              <div style={{ position: "absolute", borderRadius: "inherit", cornerShape: "inherit", top: "0", right: "0", bottom: "0", left: "0" }}>
                                <img decoding={"async"} width={"2250"} height={"1500"} sizes={"(min-width: 1280px) max(max(min(max(100vw - 40px, 1px), 1320px) - 60px, 370px), 1px), (min-width: 992px) and (max-width: 1279px) max(max(min(max(100vw - 40px, 1px), 1320px) - 40px, 300px), 1px)"} srcSet={"/assets/beauregard/community.webp"} src={"/assets/beauregard/community.webp"} alt={"Thumbnail"} style={{ display: "block", width: "100%", height: "100%", borderRadius: "inherit", cornerShape: "inherit", objectPosition: "center", objectFit: "cover" }} />
                              </div>
                            </div>
                          </div>
                        </a>
