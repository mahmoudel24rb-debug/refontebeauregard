    ...
    <>
      <div id={"main"}>
        <div className={"framer-9MYi8 framer-13v9dm1"} data-layout-template={"true"} style={{ minHeight: "100vh", width: "auto" }}>
          <div className={"framer-GgSVA framer-fN9WN framer-dct0G framer-gbuwA framer-1eSXM framer-80BYq framer-OEeSB framer-QZUlF framer-zUcIZ framer-Suf9V framer-QlV1W framer-HccBw framer-FUgh0 framer-148l8mm"} style={{ minHeight: "100vh", width: "auto", display: "contents" }}>
            <div className={"framer-9gk10v-container"}>
              <div className={"ssr-variant hidden-yelqzk hidden-1290xt5"}>
            ...
            <section className={"framer-lwyly8"} data-framer-name={"Inner Banner Section"}>
              <div className={"ssr-variant hidden-yelqzk"}>
                <div className={"framer-1t6yhw1"} data-framer-name={"BG Element"}>
                  <div style={{ position: "absolute", borderRadius: "inherit", cornerShape: "inherit", top: "0", right: "0", bottom: "0", left: "0" }}>
              ...
              <div className={"framer-jegg9l"} data-framer-name={"Base Container"}>
                <div className={"framer-jkzr21"} data-framer-name={"Title Wrapper"} style={{ willChange: "transform", opacity: "1", transform: "none" }}>
                  ...
                  <div className={"framer-182phnk"} data-framer-name={"Author Info Wrapper"}>
                    <div className={"framer-1mclr9f"} data-framer-name={"Avatar"}>
                      <div style={{ position: "absolute", borderRadius: "inherit", cornerShape: "inherit", top: "0", right: "0", bottom: "0", left: "0" }}>
                        <img decoding={"auto"} width={"1333"} height={"2000"} sizes={"(min-width: 1280px) 46px, (min-width: 992px) and (max-width: 1279px) 46px, (max-width: 991px) 46px"} srcSet={"/assets/framerusercontent.com/images/9zAMe7elCsyzFYNlo2bjRg8Gqu0_q1cb5febc.jpg 682w,/assets/framerusercontent.com/images/9zAMe7elCsyzFYNlo2bjRg8Gqu0.jpg 1333w"} src={"/assets/framerusercontent.com/images/9zAMe7elCsyzFYNlo2bjRg8Gqu0.jpg"} alt={"Avatar"} style={{ display: "block", width: "100%", height: "100%", borderRadius: "inherit", cornerShape: "inherit", objectPosition: "46.3% 35.7%", objectFit: "cover" }} />
                      </div>
                    </div>
                ...
                <div className={"framer-xae783"} data-framer-name={"Inneer Banner Wrapper"} style={{ willChange: "transform", opacity: "1", transform: "none" }}>
                  <div className={"ssr-variant"}>
                    <div className={"framer-1lgvd6o"}>
                      <div style={{ position: "absolute", borderRadius: "inherit", cornerShape: "inherit", top: "0", right: "0", bottom: "0", left: "0" }}>
                        <img decoding={"auto"} width={"3000"} height={"2000"} sizes={"(min-width: 1280px) calc(min(100vw - 40px, 1320px) - 60px), (max-width: 991px) calc(min(100vw - 40px, 1320px) - 44px), (min-width: 992px) and (max-width: 1279px) calc(min(100vw - 40px, 1320px) - 40px)"} srcSet={"/assets/framerusercontent.com/images/CSAoHoLmF9Dt3Qy9cdT5MyPttc_qbdfb3cb8.jpg 512w,/assets/framerusercontent.com/images/CSAoHoLmF9Dt3Qy9cdT5MyPttc_q1cb5febc.jpg 1024w,/assets/framerusercontent.com/images/CSAoHoLmF9Dt3Qy9cdT5MyPttc_q5fcbabc4.jpg 2048w,/assets/framerusercontent.com/images/CSAoHoLmF9Dt3Qy9cdT5MyPttc.jpg 3000w"} src={"/assets/framerusercontent.com/images/CSAoHoLmF9Dt3Qy9cdT5MyPttc.jpg"} alt={"Thumbnail"} style={{ display: "block", width: "100%", height: "100%", borderRadius: "inherit", cornerShape: "inherit", objectPosition: "69.3% 34.3%", objectFit: "cover" }} />
                      </div>
                    </div>
                  </div>
                </div>
            ...
            <section className={"framer-k7ar3"} data-framer-name={"Details Section"}>
              <div className={"framer-1ksbsif"} data-framer-name={"Base Container"}>
                <div className={"ssr-variant"}>
            ...
            <section className={"framer-g8kiei"} data-framer-name={"Blog Section"}>
              <div className={"framer-19p3zpd"} data-framer-name={"Base Container"}>
                ...
                <div className={"framer-oitte1"}>
                  <div className={"ssr-variant hidden-yelqzk"}>
                    <div className={"ssr-variant hidden-1290xt5"}>
                      <div className={"framer-tg2q6w-container"} style={{ willChange: "transform", opacity: "1", transform: "none" }}>
                        <a className={"framer-heWyC framer-Suf9V framer-80BYq framer-1rq5pk0 framer-v-1rq5pk0 framer-16a88ct"} data-framer-name={"Default"} style={{ width: "100%", borderRadius: "10px", opacity: "1" }} href={"./high-intensity-workouts-vs-steady-state-cardio"}>
                          <div className={"framer-ej6w72"} data-framer-name={"Text Content Wrapper"} style={{ backgroundColor: "var(--token-c7f7b4a7-d22a-4efb-a894-f6581be9e186, rgb(245, 245, 245))", borderTopLeftRadius: "10px", borderTopRightRadius: "10px", opacity: "1" }}>
                            <div className={"framer-yowyh7-container"} style={{ opacity: "1" }}>
                              <div className={"framer-yEmYD framer-fN9WN framer-OI0K7 framer-1en4hj5 framer-v-1en4hj5"} data-framer-name={"Default"} style={{ backdropFilter: "blur(34px)", backgroundColor: "var(--token-ce7cac9b-68d2-43aa-b17a-9ff7b974f476, rgb(207, 231, 203))", borderRadius: "50px", opacity: "1" }}>
                                <div className={"framer-1uixvs3"} data-framer-name={"Heading"} style={{ "--extracted-r6o4lv": "var(--variable-reference-AOW62B2JF-Qi9kGBGTT)", "--framer-link-text-color": "rgb(0, 153, 255)", "--framer-link-text-decoration": "underline", "--variable-reference-AOW62B2JF-Qi9kGBGTT": "var(--token-fcc50f27-48bf-4381-8929-2fd53a7bb0e3, rgb(55, 97, 49))", transform: "none", opacity: "1" }}>
                          ...
                          <div className={"framer-1malnge"} data-framer-name={"Thumbnail"} style={{ borderBottomLeftRadius: "10px", borderBottomRightRadius: "10px", opacity: "1" }}>
                            <div className={"framer-15v64hc"} style={{ transform: "none", opacity: "1" }}>
                              <div style={{ position: "absolute", borderRadius: "inherit", cornerShape: "inherit", top: "0", right: "0", bottom: "0", left: "0" }}>
                                <img decoding={"auto"} width={"2880"} height={"1920"} sizes={"(min-width: 1280px) max(max(min(max(100vw - 40px, 1px), 1320px) - 60px, 370px), 1px), (min-width: 992px) and (max-width: 1279px) max(max(min(max(100vw - 40px, 1px), 1320px) - 40px, 300px), 1px), (max-width: 991px) max(max(min(max(100vw - 40px, 1px), 1320px) - 40px, 280px), 1px)"} srcSet={"/assets/framerusercontent.com/images/jayutf6QGOdy1YT6p1Fv882Dtaw_qbdfb3cb8.jpg 512w,/assets/framerusercontent.com/images/jayutf6QGOdy1YT6p1Fv882Dtaw_q1cb5febc.jpg 1024w,/assets/framerusercontent.com/images/jayutf6QGOdy1YT6p1Fv882Dtaw_q5fcbabc4.jpg 2048w,/assets/framerusercontent.com/images/jayutf6QGOdy1YT6p1Fv882Dtaw.jpg 2880w"} src={"/assets/framerusercontent.com/images/jayutf6QGOdy1YT6p1Fv882Dtaw.jpg"} alt={"Thumbnail"} style={{ display: "block", width: "100%", height: "100%", borderRadius: "inherit", cornerShape: "inherit", objectPosition: "22.8% 69.1%", objectFit: "cover" }} />
                              </div>
                            </div>
                          </div>
                        </a>
                    ...
                    <div className={"ssr-variant hidden-1290xt5"}>
                      <div className={"framer-tg2q6w-container"} style={{ willChange: "transform", opacity: "1", transform: "none" }}>
                        <a className={"framer-heWyC framer-Suf9V framer-80BYq framer-1rq5pk0 framer-v-1rq5pk0 framer-16a88ct"} data-framer-name={"Default"} style={{ width: "100%", borderRadius: "10px", opacity: "1" }} href={"./what-to-eat-before-and-after-a-workout"}>
                          <div className={"framer-ej6w72"} data-framer-name={"Text Content Wrapper"} style={{ backgroundColor: "var(--token-c7f7b4a7-d22a-4efb-a894-f6581be9e186, rgb(245, 245, 245))", borderTopLeftRadius: "10px", borderTopRightRadius: "10px", opacity: "1" }}>
                            <div className={"framer-yowyh7-container"} style={{ opacity: "1" }}>
                              <div className={"framer-yEmYD framer-fN9WN framer-OI0K7 framer-1en4hj5 framer-v-1en4hj5"} data-framer-name={"Default"} style={{ backdropFilter: "blur(34px)", backgroundColor: "var(--token-ce7cac9b-68d2-43aa-b17a-9ff7b974f476, rgb(207, 231, 203))", borderRadius: "50px", opacity: "1" }}>
                                <div className={"framer-1uixvs3"} data-framer-name={"Heading"} style={{ "--extracted-r6o4lv": "var(--variable-reference-AOW62B2JF-Qi9kGBGTT)", "--framer-link-text-color": "rgb(0, 153, 255)", "--framer-link-text-decoration": "underline", "--variable-reference-AOW62B2JF-Qi9kGBGTT": "var(--token-fcc50f27-48bf-4381-8929-2fd53a7bb0e3, rgb(55, 97, 49))", transform: "none", opacity: "1" }}>
                          ...
                          <div className={"framer-1malnge"} data-framer-name={"Thumbnail"} style={{ borderBottomLeftRadius: "10px", borderBottomRightRadius: "10px", opacity: "1" }}>
                            <div className={"framer-15v64hc"} style={{ transform: "none", opacity: "1" }}>
                              <div style={{ position: "absolute", borderRadius: "inherit", cornerShape: "inherit", top: "0", right: "0", bottom: "0", left: "0" }}>
                                <img decoding={"auto"} width={"2880"} height={"1839"} sizes={"(min-width: 1280px) max(max(min(max(100vw - 40px, 1px), 1320px) - 60px, 370px), 1px), (min-width: 992px) and (max-width: 1279px) max(max(min(max(100vw - 40px, 1px), 1320px) - 40px, 300px), 1px), (max-width: 991px) max(max(min(max(100vw - 40px, 1px), 1320px) - 40px, 280px), 1px)"} srcSet={"/assets/framerusercontent.com/images/AivNybUmLdbEaE4eC2hVHYVWkk_qbdfb3cb8.jpg 512w,/assets/framerusercontent.com/images/AivNybUmLdbEaE4eC2hVHYVWkk_q1cb5febc.jpg 1024w,/assets/framerusercontent.com/images/AivNybUmLdbEaE4eC2hVHYVWkk_q5fcbabc4.jpg 2048w,/assets/framerusercontent.com/images/AivNybUmLdbEaE4eC2hVHYVWkk.jpg 2880w"} src={"/assets/framerusercontent.com/images/AivNybUmLdbEaE4eC2hVHYVWkk.jpg"} alt={"Thumbnail"} style={{ display: "block", width: "100%", height: "100%", borderRadius: "inherit", cornerShape: "inherit", objectPosition: "center", objectFit: "cover" }} />
                              </div>
                            </div>
                          </div>
                        </a>
                    ...
                    <div className={"ssr-variant hidden-1290xt5"}>
                      <div className={"framer-tg2q6w-container"} style={{ willChange: "transform", opacity: "1", transform: "none" }}>
                        <a className={"framer-heWyC framer-Suf9V framer-80BYq framer-1rq5pk0 framer-v-1rq5pk0 framer-16a88ct"} data-framer-name={"Default"} style={{ width: "100%", borderRadius: "10px", opacity: "1" }} href={"./tips-for-long-lasting-performance"}>
                          <div className={"framer-ej6w72"} data-framer-name={"Text Content Wrapper"} style={{ backgroundColor: "var(--token-c7f7b4a7-d22a-4efb-a894-f6581be9e186, rgb(245, 245, 245))", borderTopLeftRadius: "10px", borderTopRightRadius: "10px", opacity: "1" }}>
                            <div className={"framer-yowyh7-container"} style={{ opacity: "1" }}>
                              <div className={"framer-yEmYD framer-fN9WN framer-OI0K7 framer-1en4hj5 framer-v-1en4hj5"} data-framer-name={"Default"} style={{ backdropFilter: "blur(34px)", backgroundColor: "var(--token-ce7cac9b-68d2-43aa-b17a-9ff7b974f476, rgb(207, 231, 203))", borderRadius: "50px", opacity: "1" }}>
                                <div className={"framer-1uixvs3"} data-framer-name={"Heading"} style={{ "--extracted-r6o4lv": "var(--variable-reference-AOW62B2JF-Qi9kGBGTT)", "--framer-link-text-color": "rgb(0, 153, 255)", "--framer-link-text-decoration": "underline", "--variable-reference-AOW62B2JF-Qi9kGBGTT": "var(--token-fcc50f27-48bf-4381-8929-2fd53a7bb0e3, rgb(55, 97, 49))", transform: "none", opacity: "1" }}>
                          ...
                          <div className={"framer-1malnge"} data-framer-name={"Thumbnail"} style={{ borderBottomLeftRadius: "10px", borderBottomRightRadius: "10px", opacity: "1" }}>
                            <div className={"framer-15v64hc"} style={{ transform: "none", opacity: "1" }}>
                              <div style={{ position: "absolute", borderRadius: "inherit", cornerShape: "inherit", top: "0", right: "0", bottom: "0", left: "0" }}>
                                <img decoding={"auto"} width={"2250"} height={"1500"} sizes={"(min-width: 1280px) max(max(min(max(100vw - 40px, 1px), 1320px) - 60px, 370px), 1px), (min-width: 992px) and (max-width: 1279px) max(max(min(max(100vw - 40px, 1px), 1320px) - 40px, 300px), 1px)"} srcSet={"/assets/framerusercontent.com/images/n1kVnB6bjxKiORFERqtZhiggos_qbdfb3cb8.jpg 512w,/assets/framerusercontent.com/images/n1kVnB6bjxKiORFERqtZhiggos_q1cb5febc.jpg 1024w,/assets/framerusercontent.com/images/n1kVnB6bjxKiORFERqtZhiggos_q5fcbabc4.jpg 2048w,/assets/framerusercontent.com/images/n1kVnB6bjxKiORFERqtZhiggos.jpg 2250w"} src={"/assets/framerusercontent.com/images/n1kVnB6bjxKiORFERqtZhiggos.jpg"} alt={"Thumbnail"} style={{ display: "block", width: "100%", height: "100%", borderRadius: "inherit", cornerShape: "inherit", objectPosition: "center", objectFit: "cover" }} />
                              </div>
                            </div>
                          </div>
                        </a>
