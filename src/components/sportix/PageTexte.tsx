        ...
        <div className={"framer-9MYi8 framer-13v9dm1"} data-layout-template={"true"} style={{ minHeight: "100vh", width: "auto" }}>
          <div className={"framer-GgSVA framer-fN9WN framer-dct0G framer-gbuwA framer-1eSXM framer-80BYq framer-OEeSB framer-QZUlF framer-zUcIZ framer-Suf9V framer-QlV1W framer-HccBw framer-FUgh0 framer-148l8mm"} style={{ minHeight: "100vh", width: "auto", display: "contents" }}>
            <div className={"framer-9gk10v-container"}>
              ...
              <div className={"ssr-variant hidden-148l8mm hidden-1290xt5"}>
              ...
              <div className={"ssr-variant hidden-148l8mm hidden-yelqzk"}>
            ...
            <section className={"framer-lwyly8"} data-framer-name={"Inner Banner Section"}>
              ...
              <div className={"framer-jegg9l"} data-framer-name={"Base Container"}>
                <div className={"framer-jkzr21"} data-framer-name={"Title Wrapper"} style={{ willChange: "auto", opacity: "1", transform: "none" }}>
            ...
            <section className={"framer-k7ar3"} data-framer-name={"Details Section"}>
              <div className={"framer-1ksbsif"} data-framer-name={"Base Container"}>
                <div className={"ssr-variant"}>
                  <div className={"framer-1csbbb"} data-framer-name={"Content"} style={{ willChange: "auto", opacity: "1", transform: "none" }}>
            ...
            <section className={"framer-g8kiei"} data-framer-name={"Blog Section"}>
              <div className={"framer-19p3zpd"} data-framer-name={"Base Container"}>
                <div className={"framer-ylam0"} data-framer-name={"Title Wrapper"} style={{ willChange: "auto", opacity: "1", transform: "none" }}>
                ...
                <div className={"framer-oitte1"}>
                  <div className={"ssr-variant hidden-yelqzk"}>
                    <div className={"ssr-variant hidden-1290xt5"}>
                      <div className={"framer-tg2q6w-container"} style={{ willChange: "auto", opacity: "1", transform: "none" }}>
                        <a className={"framer-heWyC framer-Suf9V framer-80BYq framer-1rq5pk0 framer-v-1rq5pk0 framer-16a88ct"} data-framer-name={"Default"} style={{ width: "100%", borderBottomLeftRadius: "10px", borderBottomRightRadius: "10px", borderTopLeftRadius: "10px", borderTopRightRadius: "10px" }} href={"./high-intensity-workouts-vs-steady-state-cardio"}>
                          <div className={"framer-ej6w72"} data-framer-name={"Text Content Wrapper"} style={{ backgroundColor: "var(--token-c7f7b4a7-d22a-4efb-a894-f6581be9e186, rgb(245, 245, 245))", borderTopLeftRadius: "10px", borderTopRightRadius: "10px" }}>
                            <div className={"framer-yowyh7-container"}>
                              <div className={"framer-yEmYD framer-fN9WN framer-OI0K7 framer-1en4hj5 framer-v-1en4hj5"} data-framer-name={"Default"} style={{ backdropFilter: "blur(34px)", backgroundColor: "var(--token-ce7cac9b-68d2-43aa-b17a-9ff7b974f476, rgb(207, 231, 203))", WebkitBackdropFilter: "blur(34px)", borderBottomLeftRadius: "50px", borderBottomRightRadius: "50px", borderTopLeftRadius: "50px", borderTopRightRadius: "50px" }}>
                                <div className={"framer-1uixvs3"} data-framer-name={"Heading"} style={{ "--extracted-r6o4lv": "var(--variable-reference-AOW62B2JF-Qi9kGBGTT)", "--framer-link-text-color": "rgb(0, 153, 255)", "--framer-link-text-decoration": "underline", "--variable-reference-AOW62B2JF-Qi9kGBGTT": "var(--token-fcc50f27-48bf-4381-8929-2fd53a7bb0e3, rgb(55, 97, 49))", transform: "none" }}>
                            ...
                            <div className={"framer-131jy44"} data-framer-name={"Heading"} style={{ "--extracted-1lwpl3i": "var(--token-97fc87a4-7472-48e0-baff-d882386fd651, rgb(0, 0, 0))", transform: "none" }}>
                            ...
                            <div className={"framer-1qu60hr"} data-framer-name={"Body"} style={{ "--extracted-r6o4lv": "var(--token-c3674009-0fe5-49c4-b319-05dd4e6ff53e, rgb(64, 64, 64))", transform: "none" }}>
                          ...
                          <div className={"framer-1malnge"} data-framer-name={"Thumbnail"} style={{ borderBottomLeftRadius: "10px", borderBottomRightRadius: "10px" }}>
                            <div className={"framer-15v64hc"} style={{ transform: "none" }}>
                              <div style={{ position: "absolute", borderRadius: "inherit", cornerShape: "inherit", top: "0", right: "0", bottom: "0", left: "0" }}>
                    ...
                    <div className={"ssr-variant hidden-148l8mm"}>
                      <div className={"framer-tg2q6w-container"} style={{ willChange: "auto", opacity: "1", transform: "none" }}>
                        <a className={"framer-heWyC framer-Suf9V framer-80BYq framer-1rq5pk0 framer-v-ilve1z framer-16a88ct"} data-framer-name={"Tablet"} style={{ width: "100%", borderBottomLeftRadius: "10px", borderBottomRightRadius: "10px", borderTopLeftRadius: "10px", borderTopRightRadius: "10px" }} href={"./high-intensity-workouts-vs-steady-state-cardio"}>
                          <div className={"framer-ej6w72"} data-framer-name={"Text Content Wrapper"} style={{ backgroundColor: "var(--token-c7f7b4a7-d22a-4efb-a894-f6581be9e186, rgb(245, 245, 245))", borderTopLeftRadius: "10px", borderTopRightRadius: "10px" }}>
                            <div className={"framer-yowyh7-container"}>
                              <div className={"framer-yEmYD framer-fN9WN framer-OI0K7 framer-1en4hj5 framer-v-1en4hj5"} data-framer-name={"Default"} style={{ backdropFilter: "blur(34px)", backgroundColor: "var(--token-ce7cac9b-68d2-43aa-b17a-9ff7b974f476, rgb(207, 231, 203))", WebkitBackdropFilter: "blur(34px)", borderBottomLeftRadius: "50px", borderBottomRightRadius: "50px", borderTopLeftRadius: "50px", borderTopRightRadius: "50px" }}>
                                <div className={"framer-1uixvs3"} data-framer-name={"Heading"} style={{ "--extracted-r6o4lv": "var(--variable-reference-AOW62B2JF-Qi9kGBGTT)", "--framer-link-text-color": "rgb(0, 153, 255)", "--framer-link-text-decoration": "underline", "--variable-reference-AOW62B2JF-Qi9kGBGTT": "var(--token-fcc50f27-48bf-4381-8929-2fd53a7bb0e3, rgb(55, 97, 49))", transform: "none" }}>
                    ...
                    <div className={"ssr-variant hidden-1290xt5"}>
                      <div className={"framer-tg2q6w-container"} style={{ willChange: "auto", opacity: "1", transform: "none" }}>
                        <a className={"framer-heWyC framer-Suf9V framer-80BYq framer-1rq5pk0 framer-v-1rq5pk0 framer-16a88ct"} data-framer-name={"Default"} style={{ width: "100%", borderBottomLeftRadius: "10px", borderBottomRightRadius: "10px", borderTopLeftRadius: "10px", borderTopRightRadius: "10px" }} href={"./what-to-eat-before-and-after-a-workout"}>
                          <div className={"framer-ej6w72"} data-framer-name={"Text Content Wrapper"} style={{ backgroundColor: "var(--token-c7f7b4a7-d22a-4efb-a894-f6581be9e186, rgb(245, 245, 245))", borderTopLeftRadius: "10px", borderTopRightRadius: "10px" }}>
                            <div className={"framer-yowyh7-container"}>
                              <div className={"framer-yEmYD framer-fN9WN framer-OI0K7 framer-1en4hj5 framer-v-1en4hj5"} data-framer-name={"Default"} style={{ backdropFilter: "blur(34px)", backgroundColor: "var(--token-ce7cac9b-68d2-43aa-b17a-9ff7b974f476, rgb(207, 231, 203))", WebkitBackdropFilter: "blur(34px)", borderBottomLeftRadius: "50px", borderBottomRightRadius: "50px", borderTopLeftRadius: "50px", borderTopRightRadius: "50px" }}>
                                <div className={"framer-1uixvs3"} data-framer-name={"Heading"} style={{ "--extracted-r6o4lv": "var(--variable-reference-AOW62B2JF-Qi9kGBGTT)", "--framer-link-text-color": "rgb(0, 153, 255)", "--framer-link-text-decoration": "underline", "--variable-reference-AOW62B2JF-Qi9kGBGTT": "var(--token-fcc50f27-48bf-4381-8929-2fd53a7bb0e3, rgb(55, 97, 49))", transform: "none" }}>
                    ...
                    <div className={"ssr-variant hidden-148l8mm"}>
                      <div className={"framer-tg2q6w-container"} style={{ willChange: "auto", opacity: "1", transform: "none" }}>
                        <a className={"framer-heWyC framer-Suf9V framer-80BYq framer-1rq5pk0 framer-v-ilve1z framer-16a88ct"} data-framer-name={"Tablet"} style={{ width: "100%", borderBottomLeftRadius: "10px", borderBottomRightRadius: "10px", borderTopLeftRadius: "10px", borderTopRightRadius: "10px" }} href={"./what-to-eat-before-and-after-a-workout"}>
                          <div className={"framer-ej6w72"} data-framer-name={"Text Content Wrapper"} style={{ backgroundColor: "var(--token-c7f7b4a7-d22a-4efb-a894-f6581be9e186, rgb(245, 245, 245))", borderTopLeftRadius: "10px", borderTopRightRadius: "10px" }}>
                            <div className={"framer-yowyh7-container"}>
                              <div className={"framer-yEmYD framer-fN9WN framer-OI0K7 framer-1en4hj5 framer-v-1en4hj5"} data-framer-name={"Default"} style={{ backdropFilter: "blur(34px)", backgroundColor: "var(--token-ce7cac9b-68d2-43aa-b17a-9ff7b974f476, rgb(207, 231, 203))", WebkitBackdropFilter: "blur(34px)", borderBottomLeftRadius: "50px", borderBottomRightRadius: "50px", borderTopLeftRadius: "50px", borderTopRightRadius: "50px" }}>
                                <div className={"framer-1uixvs3"} data-framer-name={"Heading"} style={{ "--extracted-r6o4lv": "var(--variable-reference-AOW62B2JF-Qi9kGBGTT)", "--framer-link-text-color": "rgb(0, 153, 255)", "--framer-link-text-decoration": "underline", "--variable-reference-AOW62B2JF-Qi9kGBGTT": "var(--token-fcc50f27-48bf-4381-8929-2fd53a7bb0e3, rgb(55, 97, 49))", transform: "none" }}>
                    ...
                    <div className={"ssr-variant hidden-1290xt5"}>
                      <div className={"framer-tg2q6w-container"} style={{ willChange: "auto", opacity: "1", transform: "none" }}>
                        <a className={"framer-heWyC framer-Suf9V framer-80BYq framer-1rq5pk0 framer-v-1rq5pk0 framer-16a88ct"} data-framer-name={"Default"} style={{ width: "100%", borderBottomLeftRadius: "10px", borderBottomRightRadius: "10px", borderTopLeftRadius: "10px", borderTopRightRadius: "10px" }} href={"./tips-for-long-lasting-performance"}>
                          <div className={"framer-ej6w72"} data-framer-name={"Text Content Wrapper"} style={{ backgroundColor: "var(--token-c7f7b4a7-d22a-4efb-a894-f6581be9e186, rgb(245, 245, 245))", borderTopLeftRadius: "10px", borderTopRightRadius: "10px" }}>
                            <div className={"framer-yowyh7-container"}>
                              <div className={"framer-yEmYD framer-fN9WN framer-OI0K7 framer-1en4hj5 framer-v-1en4hj5"} data-framer-name={"Default"} style={{ backdropFilter: "blur(34px)", backgroundColor: "var(--token-ce7cac9b-68d2-43aa-b17a-9ff7b974f476, rgb(207, 231, 203))", WebkitBackdropFilter: "blur(34px)", borderBottomLeftRadius: "50px", borderBottomRightRadius: "50px", borderTopLeftRadius: "50px", borderTopRightRadius: "50px" }}>
                                <div className={"framer-1uixvs3"} data-framer-name={"Heading"} style={{ "--extracted-r6o4lv": "var(--variable-reference-AOW62B2JF-Qi9kGBGTT)", "--framer-link-text-color": "rgb(0, 153, 255)", "--framer-link-text-decoration": "underline", "--variable-reference-AOW62B2JF-Qi9kGBGTT": "var(--token-fcc50f27-48bf-4381-8929-2fd53a7bb0e3, rgb(55, 97, 49))", transform: "none" }}>
                    ...
                    <div className={"ssr-variant hidden-148l8mm"}>
                      <div className={"framer-tg2q6w-container"} style={{ willChange: "auto", opacity: "1", transform: "none" }}>
                        <a className={"framer-heWyC framer-Suf9V framer-80BYq framer-1rq5pk0 framer-v-ilve1z framer-16a88ct"} data-framer-name={"Tablet"} style={{ width: "100%", borderBottomLeftRadius: "10px", borderBottomRightRadius: "10px", borderTopLeftRadius: "10px", borderTopRightRadius: "10px" }} href={"./tips-for-long-lasting-performance"}>
                          <div className={"framer-ej6w72"} data-framer-name={"Text Content Wrapper"} style={{ backgroundColor: "var(--token-c7f7b4a7-d22a-4efb-a894-f6581be9e186, rgb(245, 245, 245))", borderTopLeftRadius: "10px", borderTopRightRadius: "10px" }}>
                            <div className={"framer-yowyh7-container"}>
                              <div className={"framer-yEmYD framer-fN9WN framer-OI0K7 framer-1en4hj5 framer-v-1en4hj5"} data-framer-name={"Default"} style={{ backdropFilter: "blur(34px)", backgroundColor: "var(--token-ce7cac9b-68d2-43aa-b17a-9ff7b974f476, rgb(207, 231, 203))", WebkitBackdropFilter: "blur(34px)", borderBottomLeftRadius: "50px", borderBottomRightRadius: "50px", borderTopLeftRadius: "50px", borderTopRightRadius: "50px" }}>
                                <div className={"framer-1uixvs3"} data-framer-name={"Heading"} style={{ "--extracted-r6o4lv": "var(--variable-reference-AOW62B2JF-Qi9kGBGTT)", "--framer-link-text-color": "rgb(0, 153, 255)", "--framer-link-text-decoration": "underline", "--variable-reference-AOW62B2JF-Qi9kGBGTT": "var(--token-fcc50f27-48bf-4381-8929-2fd53a7bb0e3, rgb(55, 97, 49))", transform: "none" }}>
                  ...
                  <div className={"ssr-variant hidden-148l8mm hidden-1290xt5"}>
                    <div className={"framer-tg2q6w-container"} style={{ willChange: "auto", opacity: "1", transform: "none" }}>
                      <a className={"framer-heWyC framer-Suf9V framer-80BYq framer-1rq5pk0 framer-v-1erqc0j framer-16a88ct"} data-framer-name={"Phone"} style={{ width: "100%", borderBottomLeftRadius: "10px", borderBottomRightRadius: "10px", borderTopLeftRadius: "10px", borderTopRightRadius: "10px" }} href={"./high-intensity-workouts-vs-steady-state-cardio"}>
                        <div className={"framer-ej6w72"} data-framer-name={"Text Content Wrapper"} style={{ backgroundColor: "var(--token-c7f7b4a7-d22a-4efb-a894-f6581be9e186, rgb(245, 245, 245))", borderTopLeftRadius: "10px", borderTopRightRadius: "10px" }}>
                          <div className={"framer-yowyh7-container"}>
                            <div className={"framer-yEmYD framer-fN9WN framer-OI0K7 framer-1en4hj5 framer-v-1en4hj5"} data-framer-name={"Default"} style={{ backdropFilter: "blur(34px)", backgroundColor: "var(--token-ce7cac9b-68d2-43aa-b17a-9ff7b974f476, rgb(207, 231, 203))", WebkitBackdropFilter: "blur(34px)", borderBottomLeftRadius: "50px", borderBottomRightRadius: "50px", borderTopLeftRadius: "50px", borderTopRightRadius: "50px" }}>
                              <div className={"framer-1uixvs3"} data-framer-name={"Heading"} style={{ "--extracted-r6o4lv": "var(--variable-reference-AOW62B2JF-Qi9kGBGTT)", "--framer-link-text-color": "rgb(0, 153, 255)", "--framer-link-text-decoration": "underline", "--variable-reference-AOW62B2JF-Qi9kGBGTT": "var(--token-fcc50f27-48bf-4381-8929-2fd53a7bb0e3, rgb(55, 97, 49))", transform: "none" }}>
                    ...
                    <div className={"framer-tg2q6w-container"} style={{ willChange: "auto", opacity: "1", transform: "none" }}>
                      <a className={"framer-heWyC framer-Suf9V framer-80BYq framer-1rq5pk0 framer-v-1erqc0j framer-16a88ct"} data-framer-name={"Phone"} style={{ width: "100%", borderBottomLeftRadius: "10px", borderBottomRightRadius: "10px", borderTopLeftRadius: "10px", borderTopRightRadius: "10px" }} href={"./what-to-eat-before-and-after-a-workout"}>
                        <div className={"framer-ej6w72"} data-framer-name={"Text Content Wrapper"} style={{ backgroundColor: "var(--token-c7f7b4a7-d22a-4efb-a894-f6581be9e186, rgb(245, 245, 245))", borderTopLeftRadius: "10px", borderTopRightRadius: "10px" }}>
                          <div className={"framer-yowyh7-container"}>
                            <div className={"framer-yEmYD framer-fN9WN framer-OI0K7 framer-1en4hj5 framer-v-1en4hj5"} data-framer-name={"Default"} style={{ backdropFilter: "blur(34px)", backgroundColor: "var(--token-ce7cac9b-68d2-43aa-b17a-9ff7b974f476, rgb(207, 231, 203))", WebkitBackdropFilter: "blur(34px)", borderBottomLeftRadius: "50px", borderBottomRightRadius: "50px", borderTopLeftRadius: "50px", borderTopRightRadius: "50px" }}>
                              <div className={"framer-1uixvs3"} data-framer-name={"Heading"} style={{ "--extracted-r6o4lv": "var(--variable-reference-AOW62B2JF-Qi9kGBGTT)", "--framer-link-text-color": "rgb(0, 153, 255)", "--framer-link-text-decoration": "underline", "--variable-reference-AOW62B2JF-Qi9kGBGTT": "var(--token-fcc50f27-48bf-4381-8929-2fd53a7bb0e3, rgb(55, 97, 49))", transform: "none" }}>
