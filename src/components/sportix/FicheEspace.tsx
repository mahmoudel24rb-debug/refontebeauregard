        ...
        <div className={"framer-9MYi8 framer-13v9dm1"} data-layout-template={"true"} style={{ minHeight: "100vh", width: "auto" }}>
          <div className={"framer-BXoRs framer-dct0G framer-80BYq framer-OEeSB framer-QZUlF framer-zUcIZ framer-Suf9V framer-1eSXM framer-QlV1W framer-HccBw framer-FUgh0 framer-TvPE6 framer-fN9WN framer-bwk9zy"} style={{ minHeight: "100vh", width: "auto", display: "contents" }}>
            <div className={"framer-tv6a48-container"}>
              ...
              <div className={"ssr-variant hidden-1i1kz8p hidden-bwk9zy"}>
              ...
              <div className={"ssr-variant hidden-6w1zmk hidden-bwk9zy"}>
            ...
            <section className={"framer-1t1efvh"} data-framer-name={"Details Section"}>
              <div className={"framer-8eq0vw"} data-framer-name={"Base Container"}>
                <div className={"framer-dp7ayi"} data-framer-name={"Right Content Wrapper"} style={{ willChange: "auto", opacity: "1", transform: "none" }}>
                  <div className={"ssr-variant"}>
                  ...
                  <div className={"framer-vh9mqr"} data-framer-name={"Gallery Items Wrapper"}>
                    ...
                    <div className={"ssr-variant hidden-bwk9zy"}>
                      <div className={"framer-ba2zsg-container"} id={"ba2zsg"}>
                        <div className={"framer-i9ehl framer-fd4p7b framer-v-y1tcfa"} data-framer-name={"Phone & Tablet"} data-highlight={"true"} style={{ height: "100%", maxHeight: "100%", width: "100%", borderBottomLeftRadius: "10px", borderBottomRightRadius: "10px", borderTopLeftRadius: "10px", borderTopRightRadius: "10px" }} tabIndex={"0"}>
                          <div className={"framer-1aqk7oe-container"}>
                ...
                <div className={"framer-z3z90e"} data-framer-name={"Text Content Wrapper"} style={{ willChange: "auto", opacity: "1", transform: "none" }}>
                  <div className={"framer-1aphy5i"} data-framer-name={"Video Content Wrapper"} style={{ willChange: "auto", opacity: "1", transform: "none" }}>
                    ...
                    <div className={"ssr-variant"}>
                      <div className={"framer-fehi0f"} data-framer-name={"Content"} style={{ transform: "none" }}>
                        ...
                        <ul className={"framer-text"}>
                          ...
                          <li data-preset-tag={"p"} className={"framer-text framer-styles-preset-kk5vcb"}>
                            <p className={"framer-text framer-styles-preset-kk5vcb"}>
                              Coaching expert & Programs – Personalized training sessions, group workouts, and specialized fitness plans.
                            </p>
                          </li>
                          <li data-preset-tag={"p"} className={"framer-text framer-styles-preset-kk5vcb"}>
                            <p className={"framer-text framer-styles-preset-kk5vcb"}>
            ...
            <section className={"framer-1fzzps0"} data-framer-name={"Classes Section"}>
              <div className={"framer-1ml6z9w"} data-framer-name={"Base Container"}>
                <div className={"framer-yox7tk"} data-framer-name={"Title Wrapper"} style={{ willChange: "auto", opacity: "1", transform: "none" }}>
                ...
                <div className={"framer-fu5pj1"}>
                  <div className={"ssr-variant hidden-1i1kz8p"}>
                    <div className={"framer-e2ox8x-container"} style={{ willChange: "auto", opacity: "1", transform: "none" }}>
                  ...
                  <div className={"framer-3gh79q"} data-framer-name={"Nav Links Columns"}>
                    ...
                    <div className={"framer-uhploo"} data-framer-name={"Nav Links Column"} style={{ willChange: "auto", opacity: "1", transform: "none" }}>
                      ...
                      <nav className={"framer-1uskuzo"} data-framer-name={"Nav Links Column"}>
                        <div className={"framer-144bbg"} data-framer-name={"Nav Link"} style={{ "--extracted-r6o4lv": "var(--token-c3674009-0fe5-49c4-b319-05dd4e6ff53e, rgb(64, 64, 64))", transform: "none" }}>
                          <p className={"framer-text framer-styles-preset-kk5vcb"} data-styles-preset={"OSGlMNwCr"} style={{ "--framer-text-color": "var(--extracted-r6o4lv, var(--token-c3674009-0fe5-49c4-b319-05dd4e6ff53e, rgb(64, 64, 64)))" }}>
                            <a className={"framer-text framer-styles-preset-dhuzcc"} data-styles-preset={"JJzO8aUgV"} href={"./outdoor-strength-zone"}>
                              Cours collectifs
                            </a>
                          </p>
                        </div>
                        <div className={"framer-uqv70a"} data-framer-name={"Nav Link"} style={{ "--extracted-r6o4lv": "var(--token-c3674009-0fe5-49c4-b319-05dd4e6ff53e, rgb(64, 64, 64))", transform: "none" }}>
                          <p className={"framer-text framer-styles-preset-kk5vcb"} data-styles-preset={"OSGlMNwCr"} style={{ "--framer-text-color": "var(--extracted-r6o4lv, var(--token-c3674009-0fe5-49c4-b319-05dd4e6ff53e, rgb(64, 64, 64)))" }}>
                            <a className={"framer-text framer-styles-preset-dhuzcc"} data-styles-preset={"JJzO8aUgV"} href={"./recovery-mobility-lounge"}>
                              Entraînement fonctionnel
                            </a>
                          </p>
                        </div>
                        <div className={"framer-1giu5hf"} data-framer-name={"Nav Link"} style={{ "--extracted-r6o4lv": "var(--token-c3674009-0fe5-49c4-b319-05dd4e6ff53e, rgb(64, 64, 64))", transform: "none" }}>
                          <p className={"framer-text framer-styles-preset-kk5vcb"} data-styles-preset={"OSGlMNwCr"} style={{ "--framer-text-color": "var(--extracted-r6o4lv, var(--token-c3674009-0fe5-49c4-b319-05dd4e6ff53e, rgb(64, 64, 64)))" }}>
                            <a className={"framer-text framer-styles-preset-dhuzcc"} data-styles-preset={"JJzO8aUgV"} href={"./advanced-aquatics-center"}>
                              Cross / Cardio
                            </a>
                          </p>
                        </div>
                        <div className={"framer-1mpi49a"} data-framer-name={"Nav Link"} style={{ "--extracted-r6o4lv": "var(--token-c3674009-0fe5-49c4-b319-05dd4e6ff53e, rgb(64, 64, 64))", transform: "none" }}>
                          <p className={"framer-text framer-styles-preset-kk5vcb"} data-styles-preset={"OSGlMNwCr"} style={{ "--framer-text-color": "var(--extracted-r6o4lv, var(--token-c3674009-0fe5-49c4-b319-05dd4e6ff53e, rgb(64, 64, 64)))" }}>
                            <a className={"framer-text framer-styles-preset-dhuzcc"} data-styles-preset={"JJzO8aUgV"} href={"./speed-agility-tracks"}>
                              Yoga
                            </a>
                          </p>
                        </div>
                        <div className={"framer-12yg4yj"} data-framer-name={"Nav Link"} style={{ "--extracted-r6o4lv": "var(--token-c3674009-0fe5-49c4-b319-05dd4e6ff53e, rgb(64, 64, 64))", transform: "none" }}>
                          <p className={"framer-text framer-styles-preset-kk5vcb"} data-styles-preset={"OSGlMNwCr"} style={{ "--framer-text-color": "var(--extracted-r6o4lv, var(--token-c3674009-0fe5-49c4-b319-05dd4e6ff53e, rgb(64, 64, 64)))" }}>
                            <a className={"framer-text framer-styles-preset-dhuzcc"} data-styles-preset={"JJzO8aUgV"} href={"./functional-training-areas"}>
                              Pilates
                            </a>
                          </p>
                        </div>
                        <div className={"framer-1u3olo0"} data-framer-name={"Nav Link"} style={{ "--extracted-r6o4lv": "var(--token-c3674009-0fe5-49c4-b319-05dd4e6ff53e, rgb(64, 64, 64))", transform: "none" }}>
                          <p className={"framer-text framer-styles-preset-kk5vcb"} data-styles-preset={"OSGlMNwCr"} style={{ "--framer-text-color": "var(--extracted-r6o4lv, var(--token-c3674009-0fe5-49c4-b319-05dd4e6ff53e, rgb(64, 64, 64)))" }}>
                            <a className={"framer-text framer-styles-preset-dhuzcc"} data-styles-preset={"JJzO8aUgV"} href={"./gym-training-zones"}>
                              École du dos
                            </a>
                          </p>
                        </div>
