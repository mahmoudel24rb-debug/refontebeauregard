...
export default function FicheEspace() {
  return (
    <>
      <div id={"main"}>
        <div className={"framer-9MYi8 framer-13v9dm1"} data-layout-template={"true"} style={{ minHeight: "100vh", width: "auto" }}>
          <div className={"framer-BXoRs framer-dct0G framer-80BYq framer-OEeSB framer-QZUlF framer-zUcIZ framer-Suf9V framer-1eSXM framer-QlV1W framer-HccBw framer-FUgh0 framer-TvPE6 framer-fN9WN framer-bwk9zy"} style={{ minHeight: "100vh", width: "auto", display: "contents" }}>
            <div className={"framer-tv6a48-container"}>
              <div className={"ssr-variant hidden-6w1zmk hidden-1i1kz8p"}>
            ...
            <section className={"framer-1ndnwwa"} data-framer-name={"Inner Banner Section"}>
              <div className={"framer-2yz2mt"} data-framer-name={"Base Container"}>
                <div className={"framer-1k79q5o"} data-framer-name={"Inneer Banner Wrapper"} style={{ willChange: "transform", opacity: "1", transform: "none" }}>
                  <div className={"framer-1w9qtr9"} data-framer-name={"BG Color"} />
                  <div className={"ssr-variant"}>
                    <div className={"framer-19mia8p"}>
                      <div style={{ position: "absolute", borderRadius: "inherit", cornerShape: "inherit", top: "0", right: "0", bottom: "0", left: "0" }}>
                        <img decoding={"auto"} width={"2880"} height={"1920"} sizes={"(min-width: 1280px) calc(min(100vw - 40px, 1320px) - 60px), (min-width: 992px) and (max-width: 1279px) calc(min(100vw - 40px, 1320px) - 40px), (max-width: 991px) calc(min(100vw - 40px, 1320px) - 44px)"} srcSet={"/assets/framerusercontent.com/images/FJq6sPsmglZjlKcqgCo2v7nSfpM_qbdfb3cb8.jpg 512w,/assets/framerusercontent.com/images/FJq6sPsmglZjlKcqgCo2v7nSfpM_q1cb5febc.jpg 1024w,/assets/framerusercontent.com/images/FJq6sPsmglZjlKcqgCo2v7nSfpM_q5fcbabc4.jpg 2048w,/assets/framerusercontent.com/images/FJq6sPsmglZjlKcqgCo2v7nSfpM.jpg 2880w"} src={"/assets/framerusercontent.com/images/FJq6sPsmglZjlKcqgCo2v7nSfpM.jpg"} alt={"Thumbnail"} style={{ display: "block", width: "100%", height: "100%", borderRadius: "inherit", cornerShape: "inherit", objectPosition: "center", objectFit: "cover" }} />
                      </div>
                    </div>
                  </div>
                  <div className={"framer-f7ghh8"} data-framer-name={"Title Wrapper"} style={{ willChange: "transform", opacity: "1", transform: "none" }}>
                    <div className={"framer-6op51"} data-framer-name={"Heading"} style={{ transform: "none" }}>
                      <h1 className={"framer-text framer-styles-preset-1l4gnld"} data-styles-preset={"BCL_rI5ab"} style={{ "--framer-text-alignment": "center", "--framer-text-color": "var(--token-5b150902-af7d-44cd-9806-3cf99a174e98, rgb(255, 255, 255))" }}>
                        Gym &amp; Training Zones
                      </h1>
                    </div>
            ...
            <section className={"framer-1t1efvh"} data-framer-name={"Details Section"}>
              <div className={"framer-8eq0vw"} data-framer-name={"Base Container"}>
                <div className={"framer-dp7ayi"} data-framer-name={"Right Content Wrapper"} style={{ willChange: "transform", opacity: "1", transform: "none" }}>
                  <div className={"ssr-variant"}>
                    <div className={"framer-1gsyxov"} data-framer-name={"Content"} style={{ transform: "none" }}>
                      ...
                      <p className={"framer-text framer-styles-preset-kk5vcb"}>
                        Our Gym &amp; Training Zones offer a cutting-edge fitness experience with top-tier equipment, versatile workout areas, and expert-led programs. Whether you're focused on strength, endurance, or functional training, this space is designed to help you reach peak performance.
                      </p>
                    </div>
                  </div>
                  <div className={"framer-vh9mqr"} data-framer-name={"Gallery Items Wrapper"}>
                    <div className={"ssr-variant hidden-6w1zmk hidden-1i1kz8p"}>
                      <div className={"framer-ba2zsg-container"} id={"ba2zsg"}>
                        <div className={"framer-i9ehl framer-fd4p7b framer-v-fd4p7b"} data-framer-name={"Default"} data-highlight={"true"} style={{ height: "100%", width: "100%", borderRadius: "10px", opacity: "1" }} tabIndex={"0"}>
                          <div className={"framer-xgp5eh"} data-framer-name={"Image Wrapper"} style={{ opacity: "1" }}>
                            <div className={"framer-eggbba"} data-framer-name={"Image"} style={{ transform: "none", opacity: "1" }}>
                              <div style={{ position: "absolute", borderRadius: "inherit", cornerShape: "inherit", top: "0", right: "0", bottom: "0", left: "0" }}>
                                <img decoding={"auto"} width={"2880"} height={"1920"} sizes={"(min-width: 1280px) max(max(max((min((min(max(100vw - 40px, 1px), 1320px) - 60px) * 0.6, 1320px) - 20px) / 2, 50px), 1px), max((max((min(max(100vw - 40px, 1px), 1320px) - 60px) * 0.4 - 80px, 1px) - 86px) / 2, 1px)), (min-width: 992px) and (max-width: 1279px) max(max(max((min((min(max(100vw - 40px, 1px), 1320px) - 40px) * 0.55, 1320px) - 20px) / 2, 50px), 1px), max((max((min(max(100vw - 40px, 1px), 1320px) - 40px) * 0.45 - 60px, 1px) - 76px) / 2, 1px)), (max-width: 991px) max(max(100vw, 1px), max(min(max(100vw - 40px, 1px), 1320px) - 80px, 220px))"} srcSet={"/assets/framerusercontent.com/images/NGHaa5tqICfG7gJyPeFzGpbTo9Y_qbdfb3cb8.jpg 512w,/assets/framerusercontent.com/images/NGHaa5tqICfG7gJyPeFzGpbTo9Y_q1cb5febc.jpg 1024w,/assets/framerusercontent.com/images/NGHaa5tqICfG7gJyPeFzGpbTo9Y_q5fcbabc4.jpg 2048w,/assets/framerusercontent.com/images/NGHaa5tqICfG7gJyPeFzGpbTo9Y.jpg 2880w"} src={"/assets/framerusercontent.com/images/NGHaa5tqICfG7gJyPeFzGpbTo9Y.jpg"} alt={"Gym"} style={{ display: "block", width: "100%", height: "100%", borderRadius: "inherit", cornerShape: "inherit", objectPosition: "center", objectFit: "cover" }} />
                              </div>
                            </div>
                          </div>
                        </div>
                    ...
                    <div className={"ssr-variant hidden-6w1zmk hidden-1i1kz8p"}>
                      <div className={"framer-1qzpsm7-container"} id={"1qzpsm7"}>
                        <div className={"framer-i9ehl framer-fd4p7b framer-v-fd4p7b"} data-framer-name={"Default"} data-highlight={"true"} style={{ height: "100%", width: "100%", borderRadius: "10px", opacity: "1" }} tabIndex={"0"}>
                          <div className={"framer-xgp5eh"} data-framer-name={"Image Wrapper"} style={{ opacity: "1" }}>
                            <div className={"framer-eggbba"} data-framer-name={"Image"} style={{ transform: "none", opacity: "1" }}>
                              <div style={{ position: "absolute", borderRadius: "inherit", cornerShape: "inherit", top: "0", right: "0", bottom: "0", left: "0" }}>
                                <img decoding={"auto"} width={"2880"} height={"1920"} sizes={"(min-width: 1280px) max(max((min((min(max(100vw - 40px, 1px), 1320px) - 60px) * 0.6, 1320px) - 20px) / 2, 50px), 1px), (min-width: 992px) and (max-width: 1279px) max(max((min((min(max(100vw - 40px, 1px), 1320px) - 40px) * 0.55, 1320px) - 20px) / 2, 50px), 1px), (max-width: 991px) max(100vw, 1px)"} srcSet={"/assets/framerusercontent.com/images/Kg02GeJPosLh9hBBKuddNhAAyQ_qbdfb3cb8.jpg 512w,/assets/framerusercontent.com/images/Kg02GeJPosLh9hBBKuddNhAAyQ_q1cb5febc.jpg 1024w,/assets/framerusercontent.com/images/Kg02GeJPosLh9hBBKuddNhAAyQ_q5fcbabc4.jpg 2048w,/assets/framerusercontent.com/images/Kg02GeJPosLh9hBBKuddNhAAyQ.jpg 2880w"} src={"/assets/framerusercontent.com/images/Kg02GeJPosLh9hBBKuddNhAAyQ.jpg"} alt={"Gym"} style={{ display: "block", width: "100%", height: "100%", borderRadius: "inherit", cornerShape: "inherit", objectPosition: "center", objectFit: "cover" }} />
                              </div>
                            </div>
                          </div>
                        </div>
                    ...
                    <div className={"ssr-variant hidden-6w1zmk hidden-1i1kz8p"}>
                      <div className={"framer-10gr4t9-container"} id={"10gr4t9"}>
                        <div className={"framer-i9ehl framer-fd4p7b framer-v-fd4p7b"} data-framer-name={"Default"} data-highlight={"true"} style={{ height: "100%", width: "100%", borderRadius: "10px", opacity: "1" }} tabIndex={"0"}>
                          <div className={"framer-xgp5eh"} data-framer-name={"Image Wrapper"} style={{ opacity: "1" }}>
                            <div className={"framer-eggbba"} data-framer-name={"Image"} style={{ transform: "none", opacity: "1" }}>
                              <div style={{ position: "absolute", borderRadius: "inherit", cornerShape: "inherit", top: "0", right: "0", bottom: "0", left: "0" }}>
                    ...
                    <div className={"ssr-variant hidden-6w1zmk hidden-1i1kz8p"}>
                      <div className={"framer-1pfjcll-container"} id={"1pfjcll"}>
                        <div className={"framer-i9ehl framer-fd4p7b framer-v-fd4p7b"} data-framer-name={"Default"} data-highlight={"true"} style={{ height: "100%", width: "100%", borderRadius: "10px", opacity: "1" }} tabIndex={"0"}>
                          <div className={"framer-xgp5eh"} data-framer-name={"Image Wrapper"} style={{ opacity: "1" }}>
                            <div className={"framer-eggbba"} data-framer-name={"Image"} style={{ transform: "none", opacity: "1" }}>
                              <div style={{ position: "absolute", borderRadius: "inherit", cornerShape: "inherit", top: "0", right: "0", bottom: "0", left: "0" }}>
                                <img decoding={"auto"} width={"2880"} height={"1923"} sizes={"(min-width: 1280px) max(max((min((min(max(100vw - 40px, 1px), 1320px) - 60px) * 0.6, 1320px) - 20px) / 2, 50px), 1px), (min-width: 992px) and (max-width: 1279px) max(max((min((min(max(100vw - 40px, 1px), 1320px) - 40px) * 0.55, 1320px) - 20px) / 2, 50px), 1px), (max-width: 991px) max(100vw, 1px)"} srcSet={"/assets/framerusercontent.com/images/Pi77HO96n4ZqjvowCNIeVKn7c_qbdfb3cb8.jpg 512w,/assets/framerusercontent.com/images/Pi77HO96n4ZqjvowCNIeVKn7c_q1cb5febc.jpg 1024w,/assets/framerusercontent.com/images/Pi77HO96n4ZqjvowCNIeVKn7c_q5fcbabc4.jpg 2048w,/assets/framerusercontent.com/images/Pi77HO96n4ZqjvowCNIeVKn7c.jpg 2880w"} src={"/assets/framerusercontent.com/images/Pi77HO96n4ZqjvowCNIeVKn7c.jpg"} alt={"Gym"} style={{ display: "block", width: "100%", height: "100%", borderRadius: "inherit", cornerShape: "inherit", objectPosition: "center", objectFit: "cover" }} />
                              </div>
                            </div>
                          </div>
                        </div>
                  ...
                  <div className={"ssr-variant"}>
                    <div className={"framer-jvs2ai"} data-framer-name={"Content"} style={{ transform: "none" }}>
                      <p className={"framer-text framer-styles-preset-kk5vcb"}>
                        From free weights and resistance machines to innovative cardio and recovery tools, every corner of the gym is crafted to support your unique fitness journey. Certified trainers provide personalized coaching and group classes tailored to all skill levels, ensuring motivation and progress every step of the way. With a vibrant community atmosphere and flexible scheduling options, the Gym &amp; Training Zones make it easy to stay committed and push beyond your limits.
                      </p>
                    </div>
                  </div>
                </div>
                <div className={"framer-z3z90e"} data-framer-name={"Text Content Wrapper"} style={{ willChange: "transform", opacity: "1", transform: "none" }}>
                  <div className={"framer-1aphy5i"} data-framer-name={"Video Content Wrapper"} style={{ willChange: "transform", opacity: "1", transform: "none" }}>
                    <div className={"framer-19mb3k5-container"} id={"19mb3k5"}>
                    ...
                    <div className={"framer-1pzx4sp"} data-framer-name={"Body"} style={{ transform: "none" }}>
                  ...
                  <div className={"framer-oxjkmg"} data-framer-name={"Benefits Wrapper"}>
                    <div className={"ssr-variant"}>
                  ...
                  <div className={"framer-n3hqot"} data-framer-name={"Labels Wrapper"}>
                    <div className={"framer-ql4xu0-container"}>
                    ...
                    <div className={"framer-cgdvx7-container"}>
                      <div className={"framer-yEmYD framer-fN9WN framer-OI0K7 framer-1en4hj5 framer-v-dr1tqt"} data-framer-name={"Text Mini"} style={{ backdropFilter: "blur(34px)", backgroundColor: "var(--token-ce7cac9b-68d2-43aa-b17a-9ff7b974f476, rgb(207, 231, 203))", borderRadius: "50px", opacity: "1" }}>
                        <div className={"framer-1uixvs3"} data-framer-name={"Heading"} style={{ "--extracted-r6o4lv": "var(--variable-reference-AOW62B2JF-Qi9kGBGTT)", "--framer-link-text-color": "rgb(0, 153, 255)", "--framer-link-text-decoration": "underline", "--variable-reference-AOW62B2JF-Qi9kGBGTT": "var(--token-fcc50f27-48bf-4381-8929-2fd53a7bb0e3, rgb(55, 97, 49))", "--extracted-1w1cjl5": "var(--variable-reference-AOW62B2JF-Qi9kGBGTT)", transform: "none", opacity: "1" }}>
                          <h6 className={"framer-text framer-styles-preset-1qsbvd0"} data-styles-preset={"s7PQr9bro"} style={{ "--framer-text-color": "var(--extracted-1w1cjl5, var(--variable-reference-AOW62B2JF-Qi9kGBGTT))" }}>
                    ...
                    <div className={"framer-1jqojaw-container"}>
                      <div className={"framer-yEmYD framer-fN9WN framer-OI0K7 framer-1en4hj5 framer-v-dr1tqt"} data-framer-name={"Text Mini"} style={{ backdropFilter: "blur(34px)", backgroundColor: "var(--token-ce7cac9b-68d2-43aa-b17a-9ff7b974f476, rgb(207, 231, 203))", borderRadius: "50px", opacity: "1" }}>
                        <div className={"framer-1uixvs3"} data-framer-name={"Heading"} style={{ "--extracted-r6o4lv": "var(--variable-reference-AOW62B2JF-Qi9kGBGTT)", "--framer-link-text-color": "rgb(0, 153, 255)", "--framer-link-text-decoration": "underline", "--variable-reference-AOW62B2JF-Qi9kGBGTT": "var(--token-fcc50f27-48bf-4381-8929-2fd53a7bb0e3, rgb(55, 97, 49))", "--extracted-1w1cjl5": "var(--variable-reference-AOW62B2JF-Qi9kGBGTT)", transform: "none", opacity: "1" }}>
                          <h6 className={"framer-text framer-styles-preset-1qsbvd0"} data-styles-preset={"s7PQr9bro"} style={{ "--framer-text-color": "var(--extracted-1w1cjl5, var(--variable-reference-AOW62B2JF-Qi9kGBGTT))" }}>
                            Expert Coaching
                    ...
                    <div className={"framer-1vzy72i-container"}>
                      <div className={"framer-yEmYD framer-fN9WN framer-OI0K7 framer-1en4hj5 framer-v-dr1tqt"} data-framer-name={"Text Mini"} style={{ backdropFilter: "blur(34px)", backgroundColor: "var(--token-ce7cac9b-68d2-43aa-b17a-9ff7b974f476, rgb(207, 231, 203))", borderRadius: "50px", opacity: "1" }}>
                        <div className={"framer-1uixvs3"} data-framer-name={"Heading"} style={{ "--extracted-r6o4lv": "var(--variable-reference-AOW62B2JF-Qi9kGBGTT)", "--framer-link-text-color": "rgb(0, 153, 255)", "--framer-link-text-decoration": "underline", "--variable-reference-AOW62B2JF-Qi9kGBGTT": "var(--token-fcc50f27-48bf-4381-8929-2fd53a7bb0e3, rgb(55, 97, 49))", "--extracted-1w1cjl5": "var(--variable-reference-AOW62B2JF-Qi9kGBGTT)", transform: "none", opacity: "1" }}>
                          <h6 className={"framer-text framer-styles-preset-1qsbvd0"} data-styles-preset={"s7PQr9bro"} style={{ "--framer-text-color": "var(--extracted-1w1cjl5, var(--variable-reference-AOW62B2JF-Qi9kGBGTT))" }}>
            ...
            <section className={"framer-1fzzps0"} data-framer-name={"Classes Section"}>
              <div className={"framer-1ml6z9w"} data-framer-name={"Base Container"}>
                <div className={"framer-yox7tk"} data-framer-name={"Title Wrapper"} style={{ willChange: "transform", opacity: "1", transform: "none" }}>
                  <div className={"framer-1yde07c"} data-framer-name={"Body"} style={{ transform: "none" }}>
                ...
                <div className={"framer-fu5pj1"}>
                  <div className={"ssr-variant hidden-1i1kz8p"}>
                    <div className={"framer-e2ox8x-container"} style={{ willChange: "transform", opacity: "1", transform: "none" }}>
                    ...
                    <div className={"framer-uhploo"} data-framer-name={"Nav Links Column"} style={{ willChange: "transform", opacity: "1", transform: "none" }}>
                      ...
                      <nav className={"framer-1uskuzo"} data-framer-name={"Nav Links Column"} style={{ opacity: "1" }}>
                        <div className={"framer-144bbg"} data-framer-name={"Nav Link"} style={{ "--extracted-r6o4lv": "var(--token-c3674009-0fe5-49c4-b319-05dd4e6ff53e, rgb(64, 64, 64))", transform: "none", opacity: "1" }}>
                          <p className={"framer-text framer-styles-preset-kk5vcb"} data-styles-preset={"OSGlMNwCr"} style={{ "--framer-text-color": "var(--extracted-r6o4lv, var(--token-c3674009-0fe5-49c4-b319-05dd4e6ff53e, rgb(64, 64, 64)))" }}>
                            <a className={"framer-text framer-styles-preset-1ml9phj"} data-styles-preset={"L9EMt_vMH"} href={"./outdoor-strength-zone"}>
                        ...
                        <div className={"framer-uqv70a"} data-framer-name={"Nav Link"} style={{ "--extracted-r6o4lv": "var(--token-c3674009-0fe5-49c4-b319-05dd4e6ff53e, rgb(64, 64, 64))", transform: "none", opacity: "1" }}>
                          <p className={"framer-text framer-styles-preset-kk5vcb"} data-styles-preset={"OSGlMNwCr"} style={{ "--framer-text-color": "var(--extracted-r6o4lv, var(--token-c3674009-0fe5-49c4-b319-05dd4e6ff53e, rgb(64, 64, 64)))" }}>
                            <a className={"framer-text framer-styles-preset-1ml9phj"} data-styles-preset={"L9EMt_vMH"} href={"./recovery-mobility-lounge"}>
                        ...
                        <div className={"framer-1giu5hf"} data-framer-name={"Nav Link"} style={{ "--extracted-r6o4lv": "var(--token-c3674009-0fe5-49c4-b319-05dd4e6ff53e, rgb(64, 64, 64))", transform: "none", opacity: "1" }}>
                          <p className={"framer-text framer-styles-preset-kk5vcb"} data-styles-preset={"OSGlMNwCr"} style={{ "--framer-text-color": "var(--extracted-r6o4lv, var(--token-c3674009-0fe5-49c4-b319-05dd4e6ff53e, rgb(64, 64, 64)))" }}>
                            <a className={"framer-text framer-styles-preset-1ml9phj"} data-styles-preset={"L9EMt_vMH"} href={"./advanced-aquatics-center"}>
                        ...
                        <div className={"framer-1mpi49a"} data-framer-name={"Nav Link"} style={{ "--extracted-r6o4lv": "var(--token-c3674009-0fe5-49c4-b319-05dd4e6ff53e, rgb(64, 64, 64))", transform: "none", opacity: "1" }}>
                          <p className={"framer-text framer-styles-preset-kk5vcb"} data-styles-preset={"OSGlMNwCr"} style={{ "--framer-text-color": "var(--extracted-r6o4lv, var(--token-c3674009-0fe5-49c4-b319-05dd4e6ff53e, rgb(64, 64, 64)))" }}>
                            <a className={"framer-text framer-styles-preset-1ml9phj"} data-styles-preset={"L9EMt_vMH"} href={"./speed-agility-tracks"}>
                        ...
                        <div className={"framer-12yg4yj"} data-framer-name={"Nav Link"} style={{ "--extracted-r6o4lv": "var(--token-c3674009-0fe5-49c4-b319-05dd4e6ff53e, rgb(64, 64, 64))", transform: "none", opacity: "1" }}>
                          <p className={"framer-text framer-styles-preset-kk5vcb"} data-styles-preset={"OSGlMNwCr"} style={{ "--framer-text-color": "var(--extracted-r6o4lv, var(--token-c3674009-0fe5-49c4-b319-05dd4e6ff53e, rgb(64, 64, 64)))" }}>
                            <a className={"framer-text framer-styles-preset-1ml9phj"} data-styles-preset={"L9EMt_vMH"} href={"./functional-training-areas"}>
                        ...
                        <div className={"framer-1u3olo0"} data-framer-name={"Nav Link"} style={{ "--extracted-r6o4lv": "var(--token-c3674009-0fe5-49c4-b319-05dd4e6ff53e, rgb(64, 64, 64))", transform: "none", opacity: "1" }}>
                          <p className={"framer-text framer-styles-preset-kk5vcb"} data-styles-preset={"OSGlMNwCr"} style={{ "--framer-text-color": "var(--extracted-r6o4lv, var(--token-c3674009-0fe5-49c4-b319-05dd4e6ff53e, rgb(64, 64, 64)))" }}>
                            <a className={"framer-text framer-styles-preset-1ml9phj"} data-styles-preset={"L9EMt_vMH"} href={"./gym-training-zones"}>
                              Gym &amp; Training Zones
                            </a>
                          </p>
                        </div>
