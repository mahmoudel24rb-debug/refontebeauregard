    ...
    <>
      <div id={"main"}>
        <div className={"framer-9MYi8 framer-13v9dm1"} data-layout-template={"true"} style={{ minHeight: "100vh", width: "auto" }}>
          <div className={"framer-4ludN framer-gbuwA framer-fN9WN framer-1b3og6o"} style={{ minHeight: "100vh", width: "auto", display: "contents" }}>
            <div className={"framer-1d119p7-container"}>
              <div className={"ssr-variant hidden-lz025w hidden-1m39nsp"}>
                <nav className={"framer-dN4YR framer-X8adU framer-SgNSh framer-DiAdc framer-12z1cd1 framer-v-12nfnzz"} data-framer-name={"Desktop Dark"} style={{ width: "100%", borderTopLeftRadius: "0px", borderTopRightRadius: "0px", opacity: "1" }}>
                  <div className={"framer-171f0ex"} data-framer-name={"Content Wrapper With BG"} style={{ backdropFilter: "none", backgroundColor: "var(--token-c7f7b4a7-d22a-4efb-a894-f6581be9e186, rgb(245, 245, 245))", borderRadius: "100px", opacity: "1" }}>
                    <div className={"framer-rpv4hj"} data-framer-name={"Base Container"} style={{ opacity: "1" }}>
                        ...
                        <div className={"framer-1jlunes-container"} style={{ opacity: "1" }}>
                          <a className={"framer-hD525 framer-do1alt framer-v-13f11kk framer-4j1ocn"} data-framer-name={"Logo Company Dark"} href={"/"} style={{ height: "100%", width: "100%", opacity: "1" }}>
                            <div style={{ position: "absolute", borderRadius: "inherit", cornerShape: "inherit", top: "0", right: "0", bottom: "0", left: "0" }}>
                              <img decoding={"auto"} width={"111"} height={"23"} src={"/assets/framerusercontent.com/images/eMs4EJNenduD63PdYh3FSUcrWk.svg"} alt={"Logo Company"} style={{ display: "block", width: "100%", height: "100%", borderRadius: "inherit", cornerShape: "inherit", objectPosition: "center", objectFit: "contain" }} />
                            </div>
                          </a>
                        </div>
                      </div>
                      <nav className={"framer-k1prli"} data-framer-name={"Nav Links Wrapper"} style={{ opacity: "1" }}>
                        ...
                        <div className={"framer-ncrdxr"} data-framer-name={"Navigation Link"} style={{ "--extracted-r6o4lv": "var(--token-5b150902-af7d-44cd-9806-3cf99a174e98, rgb(255, 255, 255))", transform: "none", opacity: "1" }}>
                          ...
                          </p><div data-bg-submenu="true"><a href="/espaces/cours-collectifs">Cours collectifs</a><a href="/espaces/fonctionnel">Entraînement fonctionnel</a><a href="/espaces/cross-cardio">Cross / Cardio</a><a href="/espaces/kid-fitness">Kid Fitness</a></div>
                        </div>
            ...
            <section className={"framer-19clka8"} data-framer-name={"Inner Banner Section"}>
              <div className={"ssr-variant hidden-lz025w"}>
                <div className={"framer-1qzig7g"} data-framer-name={"BG Element"}>
                  <div style={{ position: "absolute", borderRadius: "inherit", cornerShape: "inherit", top: "0", right: "0", bottom: "0", left: "0" }}>
                    <img decoding={"auto"} width={"1920"} height={"375"} sizes={"(min-width: 1280px) calc(100vw - 40px), (min-width: 992px) and (max-width: 1279px) calc(100vw - 40px), (max-width: 991px) calc(100vw - 40px)"} srcSet={"/assets/framerusercontent.com/images/9DURixdLAKuMtn1bnVxkx4C5Y78_qbdfb3cb8.svg 512w,/assets/framerusercontent.com/images/9DURixdLAKuMtn1bnVxkx4C5Y78_q1cb5febc.svg 1024w,/assets/framerusercontent.com/images/9DURixdLAKuMtn1bnVxkx4C5Y78.svg 1920w"} src={"/assets/framerusercontent.com/images/9DURixdLAKuMtn1bnVxkx4C5Y78.svg"} alt={"Decorative Element"} style={{ display: "block", width: "100%", height: "100%", borderRadius: "inherit", cornerShape: "inherit", objectPosition: "center", objectFit: "contain" }} />
                  </div>
                </div>
              </div>
              <div className={"framer-jquf9i"} data-framer-name={"Base Container"}>
                <div className={"framer-tnirkc"} data-framer-name={"Title Wrapper"} style={{ willChange: "transform", opacity: "1", transform: "none" }}>
                  <div className={"ssr-variant hidden-lz025w hidden-1m39nsp"}>
                ...
                <div className={"framer-1u3sfg2"} data-framer-name={"Inneer Banner Wrapper"} style={{ willChange: "transform", opacity: "1", transform: "none" }}>
                  <div className={"ssr-variant"}>
                    <div className={"framer-1l1l3n0 hidden-lz025w"} data-framer-name={"BG Element"}>
                      <div style={{ position: "absolute", borderRadius: "inherit", cornerShape: "inherit", top: "0", right: "0", bottom: "0", left: "0" }}>
                        <img decoding={"auto"} width={"2499"} height={"993"} sizes={"(min-width: 1280px) calc(min(100vw - 40px, 1320px) - 58px), (max-width: 991px) calc(min(100vw - 40px, 1320px) - 58px), (min-width: 992px) and (max-width: 1279px) calc(min(100vw - 40px, 1320px) - 38px)"} srcSet={"/assets/framerusercontent.com/images/svAeLHz91HhfHbYKLujxxdUWY_qbdfb3cb8.svg 512w,/assets/framerusercontent.com/images/svAeLHz91HhfHbYKLujxxdUWY_q1cb5febc.svg 1024w,/assets/framerusercontent.com/images/svAeLHz91HhfHbYKLujxxdUWY_q5fcbabc4.svg 2048w,/assets/framerusercontent.com/images/svAeLHz91HhfHbYKLujxxdUWY.svg 2499w"} src={"/assets/framerusercontent.com/images/svAeLHz91HhfHbYKLujxxdUWY.svg"} alt={"BG"} style={{ display: "block", width: "100%", height: "100%", borderRadius: "inherit", cornerShape: "inherit", objectPosition: "center", objectFit: "cover" }} />
                      </div>
                    </div>
                  </div>
                  <div className={"ssr-variant"}>
                    <div className={"framer-b1cuw"} data-border={"true"}>
                      <div style={{ position: "absolute", borderRadius: "inherit", cornerShape: "inherit", top: "0", right: "0", bottom: "0", left: "0" }}>
                        <img decoding={"auto"} width={"3000"} height={"2000"} sizes={"(min-width: 1280px) max(min(100vw - 40px, 1320px) - 60px, 1px), (max-width: 991px) max(min(100vw - 40px, 1320px) - 40px, 1px), (min-width: 992px) and (max-width: 1279px) max(min(100vw - 40px, 1320px) - 40px, 1px)"} srcSet={"/assets/framerusercontent.com/images/JZ1Vbu9fgdvaahtBM6j1ussrRo_qbdfb3cb8.jpg 512w,/assets/framerusercontent.com/images/JZ1Vbu9fgdvaahtBM6j1ussrRo_q1cb5febc.jpg 1024w,/assets/framerusercontent.com/images/JZ1Vbu9fgdvaahtBM6j1ussrRo_q5fcbabc4.jpg 2048w,/assets/framerusercontent.com/images/JZ1Vbu9fgdvaahtBM6j1ussrRo.jpg 3000w"} src={"/assets/framerusercontent.com/images/JZ1Vbu9fgdvaahtBM6j1ussrRo.jpg"} alt={"Athlete"} style={{ display: "block", width: "100%", height: "100%", borderRadius: "inherit", cornerShape: "inherit", objectPosition: "45.4% 40.5%", objectFit: "cover" }} />
                      </div>
                    </div>
                  </div>
                </div>
            ...
            <section className={"framer-1nmvhtn"} data-framer-name={"Facilities Section"}>
              <div className={"framer-1t0bvnw"} data-framer-name={"Base Container"}>
                ...
                <div className={"framer-cqyhae"}>
                  <div className={"ssr-variant hidden-lz025w"}>
                    <div className={"framer-fhelfb-container"} id={"outdoor-strength-zone-fhelfb"}>
                      <div className={"framer-NNZl9 framer-ovLcB framer-QlV1W framer-FUgh0 framer-80BYq framer-Suf9V framer-vkloki framer-v-vkloki"} data-framer-name={"Default"} style={{ width: "100%", willChange: "transform", opacity: "1", transform: "none" }}>
                        <div className={"framer-3nhjgs"} data-framer-name={"Text Content Wrapper"} style={{ opacity: "1" }}>
                          <div className={"framer-1wwsb11"} data-framer-name={"Text Content Wrapper"} style={{ opacity: "1" }}>
                            <div className={"framer-15o99lw"} data-framer-name={"Title Wrapper"} style={{ opacity: "1" }}>
                              <div className={"framer-19yjhu0"} data-framer-name={"Heading"} style={{ "--extracted-a0htzi": "var(--token-97fc87a4-7472-48e0-baff-d882386fd651, rgb(0, 0, 0))", transform: "none", opacity: "1" }}>
                              ...
                              <div className={"framer-1wlwkt8"} data-framer-name={"Labels Wrapper"} style={{ opacity: "1" }}>
                                <div className={"framer-1u0aux1-container"} style={{ opacity: "1" }}>
                                ...
                                <div className={"framer-1lx3id5-container"} style={{ opacity: "1" }}>
                                  <div className={"framer-yEmYD framer-fN9WN framer-OI0K7 framer-1en4hj5 framer-v-dr1tqt"} data-framer-name={"Text Mini"} style={{ backdropFilter: "blur(34px)", backgroundColor: "var(--token-ce7cac9b-68d2-43aa-b17a-9ff7b974f476, rgb(207, 231, 203))", borderRadius: "50px", opacity: "1" }}>
                                    <div className={"framer-1uixvs3"} data-framer-name={"Heading"} style={{ "--extracted-r6o4lv": "var(--variable-reference-AOW62B2JF-Qi9kGBGTT)", "--framer-link-text-color": "rgb(0, 153, 255)", "--framer-link-text-decoration": "underline", "--variable-reference-AOW62B2JF-Qi9kGBGTT": "var(--token-fcc50f27-48bf-4381-8929-2fd53a7bb0e3, rgb(55, 97, 49))", "--extracted-1w1cjl5": "var(--variable-reference-AOW62B2JF-Qi9kGBGTT)", transform: "none", opacity: "1" }}>
                                      <h6 className={"framer-text framer-styles-preset-1qsbvd0"} data-styles-preset={"s7PQr9bro"} style={{ "--framer-text-color": "var(--extracted-1w1cjl5, var(--variable-reference-AOW62B2JF-Qi9kGBGTT))" }}>
                                ...
                                <div className={"framer-10rgpdm-container"} style={{ opacity: "1" }}>
                                  <div className={"framer-yEmYD framer-fN9WN framer-OI0K7 framer-1en4hj5 framer-v-dr1tqt"} data-framer-name={"Text Mini"} style={{ backdropFilter: "blur(34px)", backgroundColor: "var(--token-ce7cac9b-68d2-43aa-b17a-9ff7b974f476, rgb(207, 231, 203))", borderRadius: "50px", opacity: "1" }}>
                                    <div className={"framer-1uixvs3"} data-framer-name={"Heading"} style={{ "--extracted-r6o4lv": "var(--variable-reference-AOW62B2JF-Qi9kGBGTT)", "--framer-link-text-color": "rgb(0, 153, 255)", "--framer-link-text-decoration": "underline", "--variable-reference-AOW62B2JF-Qi9kGBGTT": "var(--token-fcc50f27-48bf-4381-8929-2fd53a7bb0e3, rgb(55, 97, 49))", "--extracted-1w1cjl5": "var(--variable-reference-AOW62B2JF-Qi9kGBGTT)", transform: "none", opacity: "1" }}>
                                      <h6 className={"framer-text framer-styles-preset-1qsbvd0"} data-styles-preset={"s7PQr9bro"} style={{ "--framer-text-color": "var(--extracted-1w1cjl5, var(--variable-reference-AOW62B2JF-Qi9kGBGTT))" }}>
                                        Strength Testing
                                ...
                                <div className={"framer-eg74wj-container"} style={{ opacity: "1" }}>
                                  <div className={"framer-yEmYD framer-fN9WN framer-OI0K7 framer-1en4hj5 framer-v-dr1tqt"} data-framer-name={"Text Mini"} style={{ backdropFilter: "blur(34px)", backgroundColor: "var(--token-ce7cac9b-68d2-43aa-b17a-9ff7b974f476, rgb(207, 231, 203))", borderRadius: "50px", opacity: "1" }}>
                                    <div className={"framer-1uixvs3"} data-framer-name={"Heading"} style={{ "--extracted-r6o4lv": "var(--variable-reference-AOW62B2JF-Qi9kGBGTT)", "--framer-link-text-color": "rgb(0, 153, 255)", "--framer-link-text-decoration": "underline", "--variable-reference-AOW62B2JF-Qi9kGBGTT": "var(--token-fcc50f27-48bf-4381-8929-2fd53a7bb0e3, rgb(55, 97, 49))", "--extracted-1w1cjl5": "var(--variable-reference-AOW62B2JF-Qi9kGBGTT)", transform: "none", opacity: "1" }}>
                                      <h6 className={"framer-text framer-styles-preset-1qsbvd0"} data-styles-preset={"s7PQr9bro"} style={{ "--framer-text-color": "var(--extracted-1w1cjl5, var(--variable-reference-AOW62B2JF-Qi9kGBGTT))" }}>
                                        Progress Tracking
                          ...
                          <div className={"framer-1lr7jys"} data-framer-name={"Video Content Wrapper Default"} style={{ backgroundColor: "var(--token-c7f7b4a7-d22a-4efb-a894-f6581be9e186, rgb(245, 245, 245))", borderRadius: "10px", opacity: "1" }}>
                            <div className={"framer-qcdnow"} data-framer-name={"Body"} style={{ "--extracted-1lwpl3i": "var(--token-97fc87a4-7472-48e0-baff-d882386fd651, rgb(0, 0, 0))", "--framer-link-text-color": "rgb(0, 153, 255)", "--framer-link-text-decoration": "underline", transform: "none", opacity: "1" }}>
                            ...
                            <div className={"framer-1ujw3mz-container"} style={{ opacity: "1" }}>
                              <button className={"framer-JCmEB framer-amqr89 framer-v-amqr89"} data-framer-name={"Default"} data-highlight={"true"} data-reset={"button"} style={{ backgroundColor: "var(--token-fcc50f27-48bf-4381-8929-2fd53a7bb0e3, rgb(55, 97, 49))", borderRadius: "50%", opacity: "1" }} tabIndex={"0"}>
                                <div className={"framer-gcbn1"} data-border={"true"} data-framer-name={"Border Effect"} style={{ "--border-bottom-width": "4px", "--border-color": "var(--token-fcc50f27-48bf-4381-8929-2fd53a7bb0e3, rgb(55, 97, 49))", "--border-left-width": "4px", "--border-right-width": "4px", "--border-style": "solid", "--border-top-width": "4px", borderRadius: "50%", transform: "scale(0.85)", opacity: "1" }} />
                                <div data-framer-name={"Play Icon"} style={{ imageRendering: "pixelated", flexShrink: "0", fill: "var(--token-5b150902-af7d-44cd-9806-3cf99a174e98, rgb(255, 255, 255))", color: "var(--token-5b150902-af7d-44cd-9806-3cf99a174e98, rgb(255, 255, 255))", opacity: "1" }} className={"framer-1lx14sl"} aria-hidden={"true"}>
                                  <div className={"svgContainer"} style={{ width: "100%", height: "100%", aspectRatio: "inherit" }}>
                                    <svg style={{ width: "100%", height: "100%" }} viewBox={"0 0 24 24"} preserveAspectRatio={"none"} width={"100%"} height={"100%"}>
                            ...
                            <div className={"framer-ddeqdn"} style={{ borderRadius: "4px", opacity: "1" }}>
                              <div style={{ position: "absolute", borderRadius: "inherit", cornerShape: "inherit", top: "0", right: "0", bottom: "0", left: "0" }}>
                                <img decoding={"auto"} width={"3000"} height={"2000"} sizes={"(min-width: 1280px) max((min(max((calc(min(max(100vw - 40px, 1px), 1320px) - 60px) - 60px) / 2, 1px), max((calc(min(max(100vw - 40px, 1px), 1320px) - 60px) - 60px) / 2, 1px) * 0.8) - 76px) / 2, 1px), (max-width: 991px) calc(calc(min(max(100vw - 40px, 1px), 1320px) - 40px) - 40px), (min-width: 992px) and (max-width: 1279px) max((min(max((calc(min(max(100vw - 40px, 1px), 1320px) - 40px) - 60px) / 2, 1px), max((calc(min(max(100vw - 40px, 1px), 1320px) - 40px) - 60px) / 2, 1px) * 0.8) - 76px) / 2, 1px)"} srcSet={"/assets/framerusercontent.com/images/A4Y4PfhC2v4lfiIA5S1wuzTMWLo_qbdfb3cb8.jpg 512w,/assets/framerusercontent.com/images/A4Y4PfhC2v4lfiIA5S1wuzTMWLo_q1cb5febc.jpg 1024w,/assets/framerusercontent.com/images/A4Y4PfhC2v4lfiIA5S1wuzTMWLo_q5fcbabc4.jpg 2048w,/assets/framerusercontent.com/images/A4Y4PfhC2v4lfiIA5S1wuzTMWLo.jpg 3000w"} src={"/assets/framerusercontent.com/images/A4Y4PfhC2v4lfiIA5S1wuzTMWLo.jpg"} alt={"Video Banner"} style={{ display: "block", width: "100%", height: "100%", borderRadius: "inherit", cornerShape: "inherit", objectPosition: "66.4% 28%", objectFit: "cover" }} />
                              </div>
                            </div>
                          </div>
                        </div>
                        <div className={"framer-1mb6eoo"} data-framer-name={"Thumbnail"} style={{ borderRadius: "10px", opacity: "1" }}>
                          <a className={"framer-78b225 framer-1ja70pz"} href={"/espaces"} style={{ opacity: "1" }}>
                            <div style={{ position: "absolute", borderRadius: "inherit", cornerShape: "inherit", top: "0", right: "0", bottom: "0", left: "0" }}>
                              <img decoding={"auto"} width={"2250"} height={"1500"} sizes={"(min-width: 1280px) max((calc(min(max(100vw - 40px, 1px), 1320px) - 60px) - 60px) / 2, 1px), (max-width: 991px) max(calc(min(max(100vw - 40px, 1px), 1320px) - 40px), 1px), (min-width: 992px) and (max-width: 1279px) max((calc(min(max(100vw - 40px, 1px), 1320px) - 40px) - 60px) / 2, 1px)"} srcSet={"/assets/framerusercontent.com/images/KPZ5yCy0nxeKDYyH3vOMIT6MWo_qbdfb3cb8.jpg 512w,/assets/framerusercontent.com/images/KPZ5yCy0nxeKDYyH3vOMIT6MWo_q1cb5febc.jpg 1024w,/assets/framerusercontent.com/images/KPZ5yCy0nxeKDYyH3vOMIT6MWo_q5fcbabc4.jpg 2048w,/assets/framerusercontent.com/images/KPZ5yCy0nxeKDYyH3vOMIT6MWo.jpg 2250w"} src={"/assets/framerusercontent.com/images/KPZ5yCy0nxeKDYyH3vOMIT6MWo.jpg"} alt={"Thumbnail"} style={{ display: "block", width: "100%", height: "100%", borderRadius: "inherit", cornerShape: "inherit", objectPosition: "center", objectFit: "cover" }} />
                            </div>
                          </a>
                        </div>
                      </div>
                  ...
                  <div className={"ssr-variant hidden-lz025w"}>
                    <div className={"framer-fhelfb-container"} id={"recovery-mobility-lounge-fhelfb"}>
                      <div className={"framer-NNZl9 framer-ovLcB framer-QlV1W framer-FUgh0 framer-80BYq framer-Suf9V framer-vkloki framer-v-vkloki"} data-framer-name={"Default"} style={{ width: "100%", willChange: "transform", opacity: "1", transform: "none" }}>
                        <div className={"framer-3nhjgs"} data-framer-name={"Text Content Wrapper"} style={{ opacity: "1" }}>
                          <div className={"framer-1wwsb11"} data-framer-name={"Text Content Wrapper"} style={{ opacity: "1" }}>
                            <div className={"framer-15o99lw"} data-framer-name={"Title Wrapper"} style={{ opacity: "1" }}>
                            ...
                            <div className={"framer-qvkuxm"} data-framer-name={"Body"} style={{ "--extracted-r6o4lv": "var(--token-c3674009-0fe5-49c4-b319-05dd4e6ff53e, rgb(64, 64, 64))", transform: "none", opacity: "1" }}>
                              <p className={"framer-text framer-styles-preset-kk5vcb"} data-styles-preset={"OSGlMNwCr"} style={{ "--framer-text-color": "var(--extracted-r6o4lv, var(--token-c3674009-0fe5-49c4-b319-05dd4e6ff53e, rgb(64, 64, 64)))" }}>
                                The Recovery &amp; Mobility Lounge is a dedicated space designed to help athletes, fitness enthusiasts, and individuals prioritize recovery, reduce muscle fatigue, and improve flexibility.
                              </p>
                            </div>
                          </div>
                          <div className={"framer-1lr7jys"} data-framer-name={"Video Content Wrapper Default"} style={{ backgroundColor: "var(--token-c7f7b4a7-d22a-4efb-a894-f6581be9e186, rgb(245, 245, 245))", borderRadius: "10px", opacity: "1" }}>
                            ...
                            <div className={"framer-ddeqdn"} style={{ borderRadius: "4px", opacity: "1" }}>
                              <div style={{ position: "absolute", borderRadius: "inherit", cornerShape: "inherit", top: "0", right: "0", bottom: "0", left: "0" }}>
                                <img decoding={"auto"} width={"2250"} height={"1500"} sizes={"(min-width: 1280px) max((min(max((calc(min(max(100vw - 40px, 1px), 1320px) - 60px) - 60px) / 2, 1px), max((calc(min(max(100vw - 40px, 1px), 1320px) - 60px) - 60px) / 2, 1px) * 0.8) - 76px) / 2, 1px), (max-width: 991px) calc(calc(min(max(100vw - 40px, 1px), 1320px) - 40px) - 40px), (min-width: 992px) and (max-width: 1279px) max((min(max((calc(min(max(100vw - 40px, 1px), 1320px) - 40px) - 60px) / 2, 1px), max((calc(min(max(100vw - 40px, 1px), 1320px) - 40px) - 60px) / 2, 1px) * 0.8) - 76px) / 2, 1px)"} srcSet={"/assets/framerusercontent.com/images/H8XPaAfQ9Zi1OsGf1LZJk0246A_qbdfb3cb8.jpg 512w,/assets/framerusercontent.com/images/H8XPaAfQ9Zi1OsGf1LZJk0246A_q1cb5febc.jpg 1024w,/assets/framerusercontent.com/images/H8XPaAfQ9Zi1OsGf1LZJk0246A_q5fcbabc4.jpg 2048w,/assets/framerusercontent.com/images/H8XPaAfQ9Zi1OsGf1LZJk0246A.jpg 2250w"} src={"/assets/framerusercontent.com/images/H8XPaAfQ9Zi1OsGf1LZJk0246A.jpg"} alt={"Video Banner"} style={{ display: "block", width: "100%", height: "100%", borderRadius: "inherit", cornerShape: "inherit", objectPosition: "39% 97%", objectFit: "cover" }} />
                              </div>
                            </div>
                          </div>
                        </div>
                        <div className={"framer-1mb6eoo"} data-framer-name={"Thumbnail"} style={{ borderRadius: "10px", opacity: "1" }}>
                          <a className={"framer-78b225 framer-1ja70pz"} href={"/espaces"} style={{ opacity: "1" }}>
                            <div style={{ position: "absolute", borderRadius: "inherit", cornerShape: "inherit", top: "0", right: "0", bottom: "0", left: "0" }}>
                              <img decoding={"auto"} width={"2250"} height={"1500"} sizes={"(min-width: 1280px) max((calc(min(max(100vw - 40px, 1px), 1320px) - 60px) - 60px) / 2, 1px), (max-width: 991px) max(calc(min(max(100vw - 40px, 1px), 1320px) - 40px), 1px), (min-width: 992px) and (max-width: 1279px) max((calc(min(max(100vw - 40px, 1px), 1320px) - 40px) - 60px) / 2, 1px)"} srcSet={"/assets/framerusercontent.com/images/K26QRqKVfc2rJIH0zW8NB8A7f8_qbdfb3cb8.jpg 512w,/assets/framerusercontent.com/images/K26QRqKVfc2rJIH0zW8NB8A7f8_q1cb5febc.jpg 1024w,/assets/framerusercontent.com/images/K26QRqKVfc2rJIH0zW8NB8A7f8_q5fcbabc4.jpg 2048w,/assets/framerusercontent.com/images/K26QRqKVfc2rJIH0zW8NB8A7f8.jpg 2250w"} src={"/assets/framerusercontent.com/images/K26QRqKVfc2rJIH0zW8NB8A7f8.jpg"} alt={"Thumbnail"} style={{ display: "block", width: "100%", height: "100%", borderRadius: "inherit", cornerShape: "inherit", objectPosition: "center", objectFit: "cover" }} />
                            </div>
                          </a>
                        </div>
                      </div>
                  ...
                  <div className={"ssr-variant hidden-lz025w"}>
                    <div className={"framer-fhelfb-container"} id={"advanced-aquatics-center-fhelfb"}>
                      <div className={"framer-NNZl9 framer-ovLcB framer-QlV1W framer-FUgh0 framer-80BYq framer-Suf9V framer-vkloki framer-v-vkloki"} data-framer-name={"Default"} style={{ width: "100%", willChange: "transform", opacity: "1", transform: "none" }}>
                        <div className={"framer-3nhjgs"} data-framer-name={"Text Content Wrapper"} style={{ opacity: "1" }}>
                          <div className={"framer-1wwsb11"} data-framer-name={"Text Content Wrapper"} style={{ opacity: "1" }}>
                            <div className={"framer-15o99lw"} data-framer-name={"Title Wrapper"} style={{ opacity: "1" }}>
                            ...
                            <div className={"framer-qvkuxm"} data-framer-name={"Body"} style={{ "--extracted-r6o4lv": "var(--token-c3674009-0fe5-49c4-b319-05dd4e6ff53e, rgb(64, 64, 64))", transform: "none", opacity: "1" }}>
                              <p className={"framer-text framer-styles-preset-kk5vcb"} data-styles-preset={"OSGlMNwCr"} style={{ "--framer-text-color": "var(--extracted-r6o4lv, var(--token-c3674009-0fe5-49c4-b319-05dd4e6ff53e, rgb(64, 64, 64)))" }}>
                                Our Advanced Aquatics Center is designed for swimmers, triathletes, and fitness enthusiasts looking to enhance their water-based training.
                              </p>
                            </div>
                          </div>
                          <div className={"framer-1lr7jys"} data-framer-name={"Video Content Wrapper Default"} style={{ backgroundColor: "var(--token-c7f7b4a7-d22a-4efb-a894-f6581be9e186, rgb(245, 245, 245))", borderRadius: "10px", opacity: "1" }}>
                            ...
                            <div className={"framer-ddeqdn"} style={{ borderRadius: "4px", opacity: "1" }}>
                              <div style={{ position: "absolute", borderRadius: "inherit", cornerShape: "inherit", top: "0", right: "0", bottom: "0", left: "0" }}>
                                <img decoding={"auto"} width={"2880"} height={"1620"} sizes={"(min-width: 1280px) max((min(max((calc(min(max(100vw - 40px, 1px), 1320px) - 60px) - 60px) / 2, 1px), max((calc(min(max(100vw - 40px, 1px), 1320px) - 60px) - 60px) / 2, 1px) * 0.8) - 76px) / 2, 1px), (max-width: 991px) calc(calc(min(max(100vw - 40px, 1px), 1320px) - 40px) - 40px), (min-width: 992px) and (max-width: 1279px) max((min(max((calc(min(max(100vw - 40px, 1px), 1320px) - 40px) - 60px) / 2, 1px), max((calc(min(max(100vw - 40px, 1px), 1320px) - 40px) - 60px) / 2, 1px) * 0.8) - 76px) / 2, 1px)"} srcSet={"/assets/framerusercontent.com/images/EXuB611LXEfnItiH6clXM4bPg_qbdfb3cb8.jpg 512w,/assets/framerusercontent.com/images/EXuB611LXEfnItiH6clXM4bPg_q1cb5febc.jpg 1024w,/assets/framerusercontent.com/images/EXuB611LXEfnItiH6clXM4bPg_q5fcbabc4.jpg 2048w,/assets/framerusercontent.com/images/EXuB611LXEfnItiH6clXM4bPg.jpg 2880w"} src={"/assets/framerusercontent.com/images/EXuB611LXEfnItiH6clXM4bPg.jpg"} alt={"Video Banner"} style={{ display: "block", width: "100%", height: "100%", borderRadius: "inherit", cornerShape: "inherit", objectPosition: "center", objectFit: "cover" }} />
                              </div>
                            </div>
                          </div>
                        </div>
                        <div className={"framer-1mb6eoo"} data-framer-name={"Thumbnail"} style={{ borderRadius: "10px", opacity: "1" }}>
                          <a className={"framer-78b225 framer-1ja70pz"} href={"/espaces"} style={{ opacity: "1" }}>
                            <div style={{ position: "absolute", borderRadius: "inherit", cornerShape: "inherit", top: "0", right: "0", bottom: "0", left: "0" }}>
                              <img decoding={"auto"} width={"2880"} height={"2160"} sizes={"(min-width: 1280px) max((calc(min(max(100vw - 40px, 1px), 1320px) - 60px) - 60px) / 2, 1px), (max-width: 991px) max(calc(min(max(100vw - 40px, 1px), 1320px) - 40px), 1px), (min-width: 992px) and (max-width: 1279px) max((calc(min(max(100vw - 40px, 1px), 1320px) - 40px) - 60px) / 2, 1px)"} srcSet={"/assets/framerusercontent.com/images/RtPE4u8U2IFgt419rtuKDq0KUs_qbdfb3cb8.jpg 512w,/assets/framerusercontent.com/images/RtPE4u8U2IFgt419rtuKDq0KUs_q1cb5febc.jpg 1024w,/assets/framerusercontent.com/images/RtPE4u8U2IFgt419rtuKDq0KUs_q5fcbabc4.jpg 2048w,/assets/framerusercontent.com/images/RtPE4u8U2IFgt419rtuKDq0KUs.jpg 2880w"} src={"/assets/framerusercontent.com/images/RtPE4u8U2IFgt419rtuKDq0KUs.jpg"} alt={"Thumbnail"} style={{ display: "block", width: "100%", height: "100%", borderRadius: "inherit", cornerShape: "inherit", objectPosition: "47.6% 81%", objectFit: "cover" }} />
                            </div>
                          </a>
                        </div>
                      </div>
                  ...
                  <div className={"ssr-variant hidden-lz025w"}>
                    <div className={"framer-fhelfb-container"} id={"speed-agility-tracks-fhelfb"}>
                      <div className={"framer-NNZl9 framer-ovLcB framer-QlV1W framer-FUgh0 framer-80BYq framer-Suf9V framer-vkloki framer-v-vkloki"} data-framer-name={"Default"} style={{ width: "100%", willChange: "transform", opacity: "1", transform: "none" }}>
                        <div className={"framer-3nhjgs"} data-framer-name={"Text Content Wrapper"} style={{ opacity: "1" }}>
                          <div className={"framer-1wwsb11"} data-framer-name={"Text Content Wrapper"} style={{ opacity: "1" }}>
                            <div className={"framer-15o99lw"} data-framer-name={"Title Wrapper"} style={{ opacity: "1" }}>
                            ...
                            <div className={"framer-qvkuxm"} data-framer-name={"Body"} style={{ "--extracted-r6o4lv": "var(--token-c3674009-0fe5-49c4-b319-05dd4e6ff53e, rgb(64, 64, 64))", transform: "none", opacity: "1" }}>
                              <p className={"framer-text framer-styles-preset-kk5vcb"} data-styles-preset={"OSGlMNwCr"} style={{ "--framer-text-color": "var(--extracted-r6o4lv, var(--token-c3674009-0fe5-49c4-b319-05dd4e6ff53e, rgb(64, 64, 64)))" }}>
                                Our Speed &amp; Agility Tracks are designed to enhance your quickness, acceleration, and overall athletic performance.
                              </p>
                            </div>
                          </div>
                          <div className={"framer-1lr7jys"} data-framer-name={"Video Content Wrapper Default"} style={{ backgroundColor: "var(--token-c7f7b4a7-d22a-4efb-a894-f6581be9e186, rgb(245, 245, 245))", borderRadius: "10px", opacity: "1" }}>
                            ...
                            <div className={"framer-ddeqdn"} style={{ borderRadius: "4px", opacity: "1" }}>
                              <div style={{ position: "absolute", borderRadius: "inherit", cornerShape: "inherit", top: "0", right: "0", bottom: "0", left: "0" }}>
                                <img decoding={"auto"} width={"3000"} height={"2000"} sizes={"(min-width: 1280px) max((min(max((calc(min(max(100vw - 40px, 1px), 1320px) - 60px) - 60px) / 2, 1px), max((calc(min(max(100vw - 40px, 1px), 1320px) - 60px) - 60px) / 2, 1px) * 0.8) - 76px) / 2, 1px), (max-width: 991px) calc(calc(min(max(100vw - 40px, 1px), 1320px) - 40px) - 40px), (min-width: 992px) and (max-width: 1279px) max((min(max((calc(min(max(100vw - 40px, 1px), 1320px) - 40px) - 60px) / 2, 1px), max((calc(min(max(100vw - 40px, 1px), 1320px) - 40px) - 60px) / 2, 1px) * 0.8) - 76px) / 2, 1px)"} srcSet={"/assets/framerusercontent.com/images/TXpumDGGYopU7wOKJZxnP8OVYeY_qbdfb3cb8.jpg 512w,/assets/framerusercontent.com/images/TXpumDGGYopU7wOKJZxnP8OVYeY_q1cb5febc.jpg 1024w,/assets/framerusercontent.com/images/TXpumDGGYopU7wOKJZxnP8OVYeY_q5fcbabc4.jpg 2048w,/assets/framerusercontent.com/images/TXpumDGGYopU7wOKJZxnP8OVYeY.jpg 3000w"} src={"/assets/framerusercontent.com/images/TXpumDGGYopU7wOKJZxnP8OVYeY.jpg"} alt={"Video Banner"} style={{ display: "block", width: "100%", height: "100%", borderRadius: "inherit", cornerShape: "inherit", objectPosition: "55.9% 28.1%", objectFit: "cover" }} />
                              </div>
                            </div>
                          </div>
                        </div>
                        <div className={"framer-1mb6eoo"} data-framer-name={"Thumbnail"} style={{ borderRadius: "10px", opacity: "1" }}>
                          <a className={"framer-78b225 framer-1ja70pz"} href={"/espaces"} style={{ opacity: "1" }}>
                            <div style={{ position: "absolute", borderRadius: "inherit", cornerShape: "inherit", top: "0", right: "0", bottom: "0", left: "0" }}>
                              <img decoding={"auto"} width={"2880"} height={"1920"} sizes={"(min-width: 1280px) max((calc(min(max(100vw - 40px, 1px), 1320px) - 60px) - 60px) / 2, 1px), (max-width: 991px) max(calc(min(max(100vw - 40px, 1px), 1320px) - 40px), 1px), (min-width: 992px) and (max-width: 1279px) max((calc(min(max(100vw - 40px, 1px), 1320px) - 40px) - 60px) / 2, 1px)"} srcSet={"/assets/framerusercontent.com/images/Dstv8oqJd86I56Z7rgBZBiRmmM_qbdfb3cb8.jpg 512w,/assets/framerusercontent.com/images/Dstv8oqJd86I56Z7rgBZBiRmmM_q1cb5febc.jpg 1024w,/assets/framerusercontent.com/images/Dstv8oqJd86I56Z7rgBZBiRmmM_q5fcbabc4.jpg 2048w,/assets/framerusercontent.com/images/Dstv8oqJd86I56Z7rgBZBiRmmM.jpg 2880w"} src={"/assets/framerusercontent.com/images/Dstv8oqJd86I56Z7rgBZBiRmmM.jpg"} alt={"Thumbnail"} style={{ display: "block", width: "100%", height: "100%", borderRadius: "inherit", cornerShape: "inherit", objectPosition: "center", objectFit: "cover" }} />
                            </div>
                          </a>
                        </div>
                      </div>
                  ...
                  <div className={"ssr-variant hidden-lz025w"}>
                    <div className={"framer-fhelfb-container"} id={"functional-training-areas-fhelfb"}>
                      <div className={"framer-NNZl9 framer-ovLcB framer-QlV1W framer-FUgh0 framer-80BYq framer-Suf9V framer-vkloki framer-v-vkloki"} data-framer-name={"Default"} style={{ width: "100%", willChange: "transform", opacity: "1", transform: "none" }}>
                        <div className={"framer-3nhjgs"} data-framer-name={"Text Content Wrapper"} style={{ opacity: "1" }}>
                          <div className={"framer-1wwsb11"} data-framer-name={"Text Content Wrapper"} style={{ opacity: "1" }}>
                            <div className={"framer-15o99lw"} data-framer-name={"Title Wrapper"} style={{ opacity: "1" }}>
                            ...
                            <div className={"framer-qvkuxm"} data-framer-name={"Body"} style={{ "--extracted-r6o4lv": "var(--token-c3674009-0fe5-49c4-b319-05dd4e6ff53e, rgb(64, 64, 64))", transform: "none", opacity: "1" }}>
                              <p className={"framer-text framer-styles-preset-kk5vcb"} data-styles-preset={"OSGlMNwCr"} style={{ "--framer-text-color": "var(--extracted-r6o4lv, var(--token-c3674009-0fe5-49c4-b319-05dd4e6ff53e, rgb(64, 64, 64)))" }}>
                                Our Functional Training Areas are designed for dynamic, full-body workouts that enhance strength, mobility, endurance, and agility.
                              </p>
                            </div>
                          </div>
                          <div className={"framer-1lr7jys"} data-framer-name={"Video Content Wrapper Default"} style={{ backgroundColor: "var(--token-c7f7b4a7-d22a-4efb-a894-f6581be9e186, rgb(245, 245, 245))", borderRadius: "10px", opacity: "1" }}>
                            ...
                            <div className={"framer-ddeqdn"} style={{ borderRadius: "4px", opacity: "1" }}>
                              <div style={{ position: "absolute", borderRadius: "inherit", cornerShape: "inherit", top: "0", right: "0", bottom: "0", left: "0" }}>
                                <img decoding={"auto"} width={"2880"} height={"1920"} sizes={"(min-width: 1280px) max((min(max((calc(min(max(100vw - 40px, 1px), 1320px) - 60px) - 60px) / 2, 1px), max((calc(min(max(100vw - 40px, 1px), 1320px) - 60px) - 60px) / 2, 1px) * 0.8) - 76px) / 2, 1px), (max-width: 991px) calc(calc(min(max(100vw - 40px, 1px), 1320px) - 40px) - 40px), (min-width: 992px) and (max-width: 1279px) max((min(max((calc(min(max(100vw - 40px, 1px), 1320px) - 40px) - 60px) / 2, 1px), max((calc(min(max(100vw - 40px, 1px), 1320px) - 40px) - 60px) / 2, 1px) * 0.8) - 76px) / 2, 1px)"} srcSet={"/assets/framerusercontent.com/images/MBfkpCm4RTegVZ4IYcaFGoBr3E_qbdfb3cb8.jpg 512w,/assets/framerusercontent.com/images/MBfkpCm4RTegVZ4IYcaFGoBr3E_q1cb5febc.jpg 1024w,/assets/framerusercontent.com/images/MBfkpCm4RTegVZ4IYcaFGoBr3E_q5fcbabc4.jpg 2048w,/assets/framerusercontent.com/images/MBfkpCm4RTegVZ4IYcaFGoBr3E.jpg 2880w"} src={"/assets/framerusercontent.com/images/MBfkpCm4RTegVZ4IYcaFGoBr3E.jpg"} alt={"Video Banner"} style={{ display: "block", width: "100%", height: "100%", borderRadius: "inherit", cornerShape: "inherit", objectPosition: "center", objectFit: "cover" }} />
                              </div>
                            </div>
                          </div>
                        </div>
                        <div className={"framer-1mb6eoo"} data-framer-name={"Thumbnail"} style={{ borderRadius: "10px", opacity: "1" }}>
                          <a className={"framer-78b225 framer-1ja70pz"} href={"/espaces"} style={{ opacity: "1" }}>
                            <div style={{ position: "absolute", borderRadius: "inherit", cornerShape: "inherit", top: "0", right: "0", bottom: "0", left: "0" }}>
                              <img decoding={"auto"} width={"2880"} height={"1899"} sizes={"(min-width: 1280px) max((calc(min(max(100vw - 40px, 1px), 1320px) - 60px) - 60px) / 2, 1px), (max-width: 991px) max(calc(min(max(100vw - 40px, 1px), 1320px) - 40px), 1px), (min-width: 992px) and (max-width: 1279px) max((calc(min(max(100vw - 40px, 1px), 1320px) - 40px) - 60px) / 2, 1px)"} srcSet={"/assets/framerusercontent.com/images/9OfBzvFMytqtURWpXtDMuXYxwpc_qbdfb3cb8.jpg 512w,/assets/framerusercontent.com/images/9OfBzvFMytqtURWpXtDMuXYxwpc_q1cb5febc.jpg 1024w,/assets/framerusercontent.com/images/9OfBzvFMytqtURWpXtDMuXYxwpc_q5fcbabc4.jpg 2048w,/assets/framerusercontent.com/images/9OfBzvFMytqtURWpXtDMuXYxwpc.jpg 2880w"} src={"/assets/framerusercontent.com/images/9OfBzvFMytqtURWpXtDMuXYxwpc.jpg"} alt={"Thumbnail"} style={{ display: "block", width: "100%", height: "100%", borderRadius: "inherit", cornerShape: "inherit", objectPosition: "44.4% 35.2%", objectFit: "cover" }} />
                            </div>
                          </a>
                        </div>
                      </div>
                  ...
                  <div className={"ssr-variant hidden-lz025w"}>
                    <div className={"framer-fhelfb-container"} id={"gym-training-zones-fhelfb"}>
                      <div className={"framer-NNZl9 framer-ovLcB framer-QlV1W framer-FUgh0 framer-80BYq framer-Suf9V framer-vkloki framer-v-vkloki"} data-framer-name={"Default"} style={{ width: "100%", willChange: "transform", opacity: "1", transform: "none" }}>
                        <div className={"framer-3nhjgs"} data-framer-name={"Text Content Wrapper"} style={{ opacity: "1" }}>
                          <div className={"framer-1wwsb11"} data-framer-name={"Text Content Wrapper"} style={{ opacity: "1" }}>
                            <div className={"framer-15o99lw"} data-framer-name={"Title Wrapper"} style={{ opacity: "1" }}>
                            ...
                            <div className={"framer-qvkuxm"} data-framer-name={"Body"} style={{ "--extracted-r6o4lv": "var(--token-c3674009-0fe5-49c4-b319-05dd4e6ff53e, rgb(64, 64, 64))", transform: "none", opacity: "1" }}>
                              <p className={"framer-text framer-styles-preset-kk5vcb"} data-styles-preset={"OSGlMNwCr"} style={{ "--framer-text-color": "var(--extracted-r6o4lv, var(--token-c3674009-0fe5-49c4-b319-05dd4e6ff53e, rgb(64, 64, 64)))" }}>
                                Our Gym &amp; Training Zones offer a cutting-edge fitness experience with top-tier equipment, versatile workout areas, and expert-led programs.
                              </p>
                            </div>
                          </div>
                          <div className={"framer-1lr7jys"} data-framer-name={"Video Content Wrapper Default"} style={{ backgroundColor: "var(--token-c7f7b4a7-d22a-4efb-a894-f6581be9e186, rgb(245, 245, 245))", borderRadius: "10px", opacity: "1" }}>
                            ...
                            <div className={"framer-ddeqdn"} style={{ borderRadius: "4px", opacity: "1" }}>
                              <div style={{ position: "absolute", borderRadius: "inherit", cornerShape: "inherit", top: "0", right: "0", bottom: "0", left: "0" }}>
                                <img decoding={"auto"} width={"2880"} height={"1920"} sizes={"(min-width: 1280px) max((min(max((calc(min(max(100vw - 40px, 1px), 1320px) - 60px) - 60px) / 2, 1px), max((calc(min(max(100vw - 40px, 1px), 1320px) - 60px) - 60px) / 2, 1px) * 0.8) - 76px) / 2, 1px), (max-width: 991px) calc(calc(min(max(100vw - 40px, 1px), 1320px) - 40px) - 40px), (min-width: 992px) and (max-width: 1279px) max((min(max((calc(min(max(100vw - 40px, 1px), 1320px) - 40px) - 60px) / 2, 1px), max((calc(min(max(100vw - 40px, 1px), 1320px) - 40px) - 60px) / 2, 1px) * 0.8) - 76px) / 2, 1px)"} srcSet={"/assets/framerusercontent.com/images/NGHaa5tqICfG7gJyPeFzGpbTo9Y_qbdfb3cb8.jpg 512w,/assets/framerusercontent.com/images/NGHaa5tqICfG7gJyPeFzGpbTo9Y_q1cb5febc.jpg 1024w,/assets/framerusercontent.com/images/NGHaa5tqICfG7gJyPeFzGpbTo9Y_q5fcbabc4.jpg 2048w,/assets/framerusercontent.com/images/NGHaa5tqICfG7gJyPeFzGpbTo9Y.jpg 2880w"} src={"/assets/framerusercontent.com/images/NGHaa5tqICfG7gJyPeFzGpbTo9Y.jpg"} alt={"Video Banner"} style={{ display: "block", width: "100%", height: "100%", borderRadius: "inherit", cornerShape: "inherit", objectPosition: "50.1% 65.4%", objectFit: "cover" }} />
                              </div>
                            </div>
                          </div>
                        </div>
                        <div className={"framer-1mb6eoo"} data-framer-name={"Thumbnail"} style={{ borderRadius: "10px", opacity: "1" }}>
                          <a className={"framer-78b225 framer-1ja70pz"} href={"/espaces"} style={{ opacity: "1" }}>
                            <div style={{ position: "absolute", borderRadius: "inherit", cornerShape: "inherit", top: "0", right: "0", bottom: "0", left: "0" }}>
                              <img decoding={"auto"} width={"2880"} height={"1920"} sizes={"(min-width: 1280px) max((calc(min(max(100vw - 40px, 1px), 1320px) - 60px) - 60px) / 2, 1px), (max-width: 991px) max(calc(min(max(100vw - 40px, 1px), 1320px) - 40px), 1px), (min-width: 992px) and (max-width: 1279px) max((calc(min(max(100vw - 40px, 1px), 1320px) - 40px) - 60px) / 2, 1px)"} srcSet={"/assets/framerusercontent.com/images/FJq6sPsmglZjlKcqgCo2v7nSfpM_qbdfb3cb8.jpg 512w,/assets/framerusercontent.com/images/FJq6sPsmglZjlKcqgCo2v7nSfpM_q1cb5febc.jpg 1024w,/assets/framerusercontent.com/images/FJq6sPsmglZjlKcqgCo2v7nSfpM_q5fcbabc4.jpg 2048w,/assets/framerusercontent.com/images/FJq6sPsmglZjlKcqgCo2v7nSfpM.jpg 2880w"} src={"/assets/framerusercontent.com/images/FJq6sPsmglZjlKcqgCo2v7nSfpM.jpg"} alt={"Thumbnail"} style={{ display: "block", width: "100%", height: "100%", borderRadius: "inherit", cornerShape: "inherit", objectPosition: "center", objectFit: "cover" }} />
                            </div>
                          </a>
                        </div>
                      </div>
                  ...
                  <div className={"ssr-variant"}>
                    <div className={"framer-15ybv27-container"} style={{ willChange: "transform", opacity: "1", transform: "none" }} />
                  </div>
                </div>
              </div>
            </section>
