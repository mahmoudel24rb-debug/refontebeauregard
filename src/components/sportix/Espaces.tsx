        ...
        <div className={"framer-9MYi8 framer-13v9dm1"} data-layout-template={"true"} style={{ minHeight: "100vh", width: "auto" }}>
          <div className={"framer-4ludN framer-gbuwA framer-fN9WN framer-1b3og6o"} style={{ minHeight: "100vh", width: "auto", display: "contents" }}>
            <div className={"framer-1d119p7-container"}>
              ...
              <div className={"ssr-variant hidden-1b3og6o hidden-1m39nsp"}>
              ...
              <div className={"ssr-variant hidden-1b3og6o hidden-lz025w"}>
            ...
            <section className={"framer-19clka8"} data-framer-name={"Inner Banner Section"}>
              ...
              <div className={"framer-jquf9i"} data-framer-name={"Base Container"}>
                <div className={"framer-tnirkc"} data-framer-name={"Title Wrapper"} style={{ willChange: "auto", opacity: "1", transform: "none" }}>
                  <div className={"ssr-variant hidden-lz025w hidden-1m39nsp"}>
                ...
                <div className={"framer-1u3sfg2"} data-framer-name={"Inneer Banner Wrapper"} style={{ willChange: "transform", opacity: "0", transform: "none" }}>
            ...
            <section className={"framer-1nmvhtn"} data-framer-name={"Nos espaces Section"}>
              <div className={"framer-1t0bvnw"} data-framer-name={"Base Container"}>
                <div className={"framer-hk1ytc"} data-framer-name={"Title Wrapper"} style={{ willChange: "auto", opacity: "1", transform: "none" }}>
                  ...
                  <div className={"ssr-variant hidden-1b3og6o hidden-1m39nsp"}>
                    <div className={"framer-17htuz2"} data-framer-name={"Heading"} style={{ transform: "none" }}>
                      <h2 style={{ "--framer-font-size": "40px", "--framer-letter-spacing": "-1.5px", "--framer-text-alignment": "center", "--framer-text-color": "var(--token-97fc87a4-7472-48e0-baff-d882386fd651, rgb(0, 0, 0))" }} className={"framer-text"}>
                        L'environnement idéal pour{" "}
                        <span style={{ "--font-selector": "SW50ZXItQm9sZA==", "--framer-font-family": "&quot", "--framer-font-weight": "700" }} className={"framer-text"}>
                          repousser vos limites et progresser.
                        </span>
                ...
                <div className={"framer-cqyhae"}>
                  <div className={"ssr-variant hidden-lz025w"}>
                    <div className={"framer-fhelfb-container"} id={"outdoor-strength-zone-fhelfb"}>
                      <div className={"framer-NNZl9 framer-ovLcB framer-QlV1W framer-FUgh0 framer-80BYq framer-Suf9V framer-vkloki framer-v-vkloki"} data-framer-name={"Default"} style={{ width: "100%", willChange: "auto", opacity: "1", transform: "none" }}>
                        <div className={"framer-3nhjgs"} data-framer-name={"Text Content Wrapper"}>
                          <div className={"framer-1wwsb11"} data-framer-name={"Text Content Wrapper"}>
                            <div className={"framer-15o99lw"} data-framer-name={"Title Wrapper"}>
                              ...
                              <div className={"framer-1wlwkt8"} data-framer-name={"Labels Wrapper"}>
                                <div className={"framer-1u0aux1-container"}>
                                  <div className={"framer-yEmYD framer-fN9WN framer-OI0K7 framer-1en4hj5 framer-v-dr1tqt"} data-framer-name={"Text Mini"} style={{ backdropFilter: "blur(34px)", backgroundColor: "var(--token-ce7cac9b-68d2-43aa-b17a-9ff7b974f476, rgb(207, 231, 203))", WebkitBackdropFilter: "blur(34px)", borderBottomLeftRadius: "50px", borderBottomRightRadius: "50px", borderTopLeftRadius: "50px", borderTopRightRadius: "50px" }}>
                                    <div className={"framer-1uixvs3"} data-framer-name={"Heading"} style={{ "--extracted-r6o4lv": "var(--variable-reference-AOW62B2JF-Qi9kGBGTT)", "--framer-link-text-color": "rgb(0, 153, 255)", "--framer-link-text-decoration": "underline", "--variable-reference-AOW62B2JF-Qi9kGBGTT": "var(--token-fcc50f27-48bf-4381-8929-2fd53a7bb0e3, rgb(55, 97, 49))", "--extracted-1w1cjl5": "var(--variable-reference-AOW62B2JF-Qi9kGBGTT)", transform: "none" }}>
                                ...
                                <div className={"framer-1lx3id5-container"}>
                                  <div className={"framer-yEmYD framer-fN9WN framer-OI0K7 framer-1en4hj5 framer-v-dr1tqt"} data-framer-name={"Text Mini"} style={{ backdropFilter: "blur(34px)", backgroundColor: "var(--token-ce7cac9b-68d2-43aa-b17a-9ff7b974f476, rgb(207, 231, 203))", WebkitBackdropFilter: "blur(34px)", borderBottomLeftRadius: "50px", borderBottomRightRadius: "50px", borderTopLeftRadius: "50px", borderTopRightRadius: "50px" }}>
                                    <div className={"framer-1uixvs3"} data-framer-name={"Heading"} style={{ "--extracted-r6o4lv": "var(--variable-reference-AOW62B2JF-Qi9kGBGTT)", "--framer-link-text-color": "rgb(0, 153, 255)", "--framer-link-text-decoration": "underline", "--variable-reference-AOW62B2JF-Qi9kGBGTT": "var(--token-fcc50f27-48bf-4381-8929-2fd53a7bb0e3, rgb(55, 97, 49))", "--extracted-1w1cjl5": "var(--variable-reference-AOW62B2JF-Qi9kGBGTT)", transform: "none" }}>
                                      <h6 className={"framer-text framer-styles-preset-1qsbvd0"} data-styles-preset={"s7PQr9bro"} style={{ "--framer-text-color": "var(--extracted-1w1cjl5, var(--variable-reference-AOW62B2JF-Qi9kGBGTT))" }}>
                                ...
                                <div className={"framer-10rgpdm-container"}>
                                  <div className={"framer-yEmYD framer-fN9WN framer-OI0K7 framer-1en4hj5 framer-v-dr1tqt"} data-framer-name={"Text Mini"} style={{ backdropFilter: "blur(34px)", backgroundColor: "var(--token-ce7cac9b-68d2-43aa-b17a-9ff7b974f476, rgb(207, 231, 203))", WebkitBackdropFilter: "blur(34px)", borderBottomLeftRadius: "50px", borderBottomRightRadius: "50px", borderTopLeftRadius: "50px", borderTopRightRadius: "50px" }}>
                                    <div className={"framer-1uixvs3"} data-framer-name={"Heading"} style={{ "--extracted-r6o4lv": "var(--variable-reference-AOW62B2JF-Qi9kGBGTT)", "--framer-link-text-color": "rgb(0, 153, 255)", "--framer-link-text-decoration": "underline", "--variable-reference-AOW62B2JF-Qi9kGBGTT": "var(--token-fcc50f27-48bf-4381-8929-2fd53a7bb0e3, rgb(55, 97, 49))", "--extracted-1w1cjl5": "var(--variable-reference-AOW62B2JF-Qi9kGBGTT)", transform: "none" }}>
                                      <h6 className={"framer-text framer-styles-preset-1qsbvd0"} data-styles-preset={"s7PQr9bro"} style={{ "--framer-text-color": "var(--extracted-1w1cjl5, var(--variable-reference-AOW62B2JF-Qi9kGBGTT))" }}>
                                        Tests de force
                                ...
                                <div className={"framer-eg74wj-container"}>
                                  <div className={"framer-yEmYD framer-fN9WN framer-OI0K7 framer-1en4hj5 framer-v-dr1tqt"} data-framer-name={"Text Mini"} style={{ backdropFilter: "blur(34px)", backgroundColor: "var(--token-ce7cac9b-68d2-43aa-b17a-9ff7b974f476, rgb(207, 231, 203))", WebkitBackdropFilter: "blur(34px)", borderBottomLeftRadius: "50px", borderBottomRightRadius: "50px", borderTopLeftRadius: "50px", borderTopRightRadius: "50px" }}>
                                    <div className={"framer-1uixvs3"} data-framer-name={"Heading"} style={{ "--extracted-r6o4lv": "var(--variable-reference-AOW62B2JF-Qi9kGBGTT)", "--framer-link-text-color": "rgb(0, 153, 255)", "--framer-link-text-decoration": "underline", "--variable-reference-AOW62B2JF-Qi9kGBGTT": "var(--token-fcc50f27-48bf-4381-8929-2fd53a7bb0e3, rgb(55, 97, 49))", "--extracted-1w1cjl5": "var(--variable-reference-AOW62B2JF-Qi9kGBGTT)", transform: "none" }}>
                                      <h6 className={"framer-text framer-styles-preset-1qsbvd0"} data-styles-preset={"s7PQr9bro"} style={{ "--framer-text-color": "var(--extracted-1w1cjl5, var(--variable-reference-AOW62B2JF-Qi9kGBGTT))" }}>
                                        Suivi des progrès
                            ...
                            <div className={"framer-qvkuxm"} data-framer-name={"Body"} style={{ "--extracted-r6o4lv": "var(--token-c3674009-0fe5-49c4-b319-05dd4e6ff53e, rgb(64, 64, 64))", transform: "none" }}>
                          ...
                          <div className={"framer-1lr7jys"} data-framer-name={"Video Content Wrapper Default"} style={{ backgroundColor: "var(--token-c7f7b4a7-d22a-4efb-a894-f6581be9e186, rgb(245, 245, 245))", borderBottomLeftRadius: "10px", borderBottomRightRadius: "10px", borderTopLeftRadius: "10px", borderTopRightRadius: "10px" }}>
                            <div className={"framer-qcdnow"} data-framer-name={"Body"} style={{ "--extracted-1lwpl3i": "var(--token-97fc87a4-7472-48e0-baff-d882386fd651, rgb(0, 0, 0))", "--framer-link-text-color": "rgb(0, 153, 255)", "--framer-link-text-decoration": "underline", transform: "none" }}>
                            ...
                            <div className={"framer-1ujw3mz-container"}>
                              <button className={"framer-JCmEB framer-amqr89 framer-v-amqr89"} data-framer-name={"Default"} data-highlight={"true"} data-reset={"button"} style={{ backgroundColor: "var(--token-fcc50f27-48bf-4381-8929-2fd53a7bb0e3, rgb(55, 97, 49))", borderBottomLeftRadius: "50%", borderBottomRightRadius: "50%", borderTopLeftRadius: "50%", borderTopRightRadius: "50%" }} tabIndex={"0"}>
                                <div className={"framer-gcbn1"} data-border={"true"} data-framer-name={"Border Effect"} style={{ "--border-bottom-width": "4px", "--border-color": "var(--token-fcc50f27-48bf-4381-8929-2fd53a7bb0e3, rgb(55, 97, 49))", "--border-left-width": "4px", "--border-right-width": "4px", "--border-style": "solid", "--border-top-width": "4px", borderBottomLeftRadius: "50%", borderBottomRightRadius: "50%", borderTopLeftRadius: "50%", borderTopRightRadius: "50%", transform: "scale(0.85)" }} />
                                <div data-framer-name={"Play Icon"} style={{ imageRendering: "pixelated", flexShrink: "0", fill: "var(--token-5b150902-af7d-44cd-9806-3cf99a174e98, rgb(255, 255, 255))", color: "var(--token-5b150902-af7d-44cd-9806-3cf99a174e98, rgb(255, 255, 255))" }} className={"framer-1lx14sl"} aria-hidden={"true"}>
                                  <div className={"svgContainer"} style={{ width: "100%", height: "100%", aspectRatio: "inherit" }}>
                                    <svg style={{ width: "100%", height: "100%" }} viewBox={"0 0 24 24"}>
                            ...
                            <div className={"framer-ddeqdn"} style={{ borderBottomLeftRadius: "4px", borderBottomRightRadius: "4px", borderTopLeftRadius: "4px", borderTopRightRadius: "4px" }}>
                              <div style={{ position: "absolute", borderRadius: "inherit", cornerShape: "inherit", top: "0", right: "0", bottom: "0", left: "0" }}>
                                <img decoding={"async"} width={"3000"} height={"2000"} sizes={"(min-width: 1280px) max((min(max((calc(min(max(100vw - 40px, 1px), 1320px) - 60px) - 60px) / 2, 1px), max((calc(min(max(100vw - 40px, 1px), 1320px) - 60px) - 60px) / 2, 1px) * 0.8) - 76px) / 2, 1px), (max-width: 991px) calc(calc(min(max(100vw - 40px, 1px), 1320px) - 40px) - 40px), (min-width: 992px) and (max-width: 1279px) max((min(max((calc(min(max(100vw - 40px, 1px), 1320px) - 40px) - 60px) / 2, 1px), max((calc(min(max(100vw - 40px, 1px), 1320px) - 40px) - 60px) / 2, 1px) * 0.8) - 76px) / 2, 1px)"} srcSet={"/assets/framerusercontent.com/images/A4Y4PfhC2v4lfiIA5S1wuzTMWLo_qbdfb3cb8.jpg 512w,/assets/framerusercontent.com/images/A4Y4PfhC2v4lfiIA5S1wuzTMWLo_q1cb5febc.jpg 1024w,/assets/framerusercontent.com/images/A4Y4PfhC2v4lfiIA5S1wuzTMWLo_q5fcbabc4.jpg 2048w,/assets/framerusercontent.com/images/A4Y4PfhC2v4lfiIA5S1wuzTMWLo.jpg 3000w"} src={"/assets/framerusercontent.com/images/A4Y4PfhC2v4lfiIA5S1wuzTMWLo.jpg"} alt={"Video Banner"} style={{ display: "block", width: "100%", height: "100%", borderRadius: "inherit", cornerShape: "inherit", objectPosition: "66.4% 28%", objectFit: "cover" }} />
                              </div>
                            </div>
                          </div>
                        </div>
                        <div className={"framer-1mb6eoo"} data-framer-name={"Thumbnail"} style={{ borderBottomLeftRadius: "10px", borderBottomRightRadius: "10px", borderTopLeftRadius: "10px", borderTopRightRadius: "10px" }}>
                          <a className={"framer-78b225 framer-1ja70pz"} href={"/espaces"}>
                            <div style={{ position: "absolute", borderRadius: "inherit", cornerShape: "inherit", top: "0", right: "0", bottom: "0", left: "0" }}>
                              <img decoding={"async"} width={"2250"} height={"1500"} sizes={"(min-width: 1280px) max((calc(min(max(100vw - 40px, 1px), 1320px) - 60px) - 60px) / 2, 1px), (max-width: 991px) max(calc(min(max(100vw - 40px, 1px), 1320px) - 40px), 1px), (min-width: 992px) and (max-width: 1279px) max((calc(min(max(100vw - 40px, 1px), 1320px) - 40px) - 60px) / 2, 1px)"} srcSet={"/assets/framerusercontent.com/images/KPZ5yCy0nxeKDYyH3vOMIT6MWo_qbdfb3cb8.jpg 512w,/assets/framerusercontent.com/images/KPZ5yCy0nxeKDYyH3vOMIT6MWo_q1cb5febc.jpg 1024w,/assets/framerusercontent.com/images/KPZ5yCy0nxeKDYyH3vOMIT6MWo_q5fcbabc4.jpg 2048w,/assets/framerusercontent.com/images/KPZ5yCy0nxeKDYyH3vOMIT6MWo.jpg 2250w"} src={"/assets/framerusercontent.com/images/KPZ5yCy0nxeKDYyH3vOMIT6MWo.jpg"} alt={"Thumbnail"} style={{ display: "block", width: "100%", height: "100%", borderRadius: "inherit", cornerShape: "inherit", objectPosition: "center", objectFit: "cover" }} />
                            </div>
                          </a>
                        </div>
                      </div>
                  ...
                  <div className={"ssr-variant hidden-1b3og6o hidden-1m39nsp"}>
                    <div className={"framer-fhelfb-container"} id={"outdoor-strength-zone-fhelfb"}>
                      <div className={"framer-NNZl9 framer-ovLcB framer-QlV1W framer-FUgh0 framer-80BYq framer-Suf9V framer-vkloki framer-v-11tckh3"} data-framer-name={"Phone"} style={{ width: "100%", willChange: "auto", opacity: "1", transform: "none" }}>
                        <div className={"framer-3nhjgs"} data-framer-name={"Text Content Wrapper"}>
                          <div className={"framer-1wwsb11"} data-framer-name={"Text Content Wrapper"}>
                            <div className={"framer-15o99lw"} data-framer-name={"Title Wrapper"}>
                              <div className={"framer-19yjhu0"} data-framer-name={"Heading"} style={{ "--extracted-a0htzi": "var(--token-97fc87a4-7472-48e0-baff-d882386fd651, rgb(0, 0, 0))", transform: "none" }}>
                      ...
                      <div className={"framer-NNZl9 framer-ovLcB framer-QlV1W framer-FUgh0 framer-80BYq framer-Suf9V framer-vkloki framer-v-vkloki"} data-framer-name={"Default"} style={{ width: "100%", willChange: "auto", opacity: "1", transform: "none" }}>
                        <div className={"framer-3nhjgs"} data-framer-name={"Text Content Wrapper"}>
                          <div className={"framer-1wwsb11"} data-framer-name={"Text Content Wrapper"}>
                            ...
                            <div className={"framer-qvkuxm"} data-framer-name={"Body"} style={{ "--extracted-r6o4lv": "var(--token-c3674009-0fe5-49c4-b319-05dd4e6ff53e, rgb(64, 64, 64))", transform: "none" }}>
                              <p className={"framer-text framer-styles-preset-kk5vcb"} data-styles-preset={"OSGlMNwCr"} style={{ "--framer-text-color": "var(--extracted-r6o4lv, var(--token-c3674009-0fe5-49c4-b319-05dd4e6ff53e, rgb(64, 64, 64)))" }}>
                                The Récupération & Mobility Lounge is a dedicated space designed to help athletes, fitness enthusiasts, and individuals prioritize recovery, reduce muscle fatigue, and improve flexibility.
                              </p>
                            </div>
                          </div>
                          <div className={"framer-1lr7jys"} data-framer-name={"Video Content Wrapper Default"} style={{ backgroundColor: "var(--token-c7f7b4a7-d22a-4efb-a894-f6581be9e186, rgb(245, 245, 245))", borderBottomLeftRadius: "10px", borderBottomRightRadius: "10px", borderTopLeftRadius: "10px", borderTopRightRadius: "10px" }}>
                      ...
                      <div className={"framer-NNZl9 framer-ovLcB framer-QlV1W framer-FUgh0 framer-80BYq framer-Suf9V framer-vkloki framer-v-vkloki"} data-framer-name={"Default"} style={{ width: "100%", willChange: "auto", opacity: "1", transform: "none" }}>
                        <div className={"framer-3nhjgs"} data-framer-name={"Text Content Wrapper"}>
                          ...
                          <div className={"framer-1lr7jys"} data-framer-name={"Video Content Wrapper Default"} style={{ backgroundColor: "var(--token-c7f7b4a7-d22a-4efb-a894-f6581be9e186, rgb(245, 245, 245))", borderBottomLeftRadius: "10px", borderBottomRightRadius: "10px", borderTopLeftRadius: "10px", borderTopRightRadius: "10px" }}>
                            ...
                            <div className={"framer-ddeqdn"} style={{ borderBottomLeftRadius: "4px", borderBottomRightRadius: "4px", borderTopLeftRadius: "4px", borderTopRightRadius: "4px" }}>
                              <div style={{ position: "absolute", borderRadius: "inherit", cornerShape: "inherit", top: "0", right: "0", bottom: "0", left: "0" }}>
                                <img decoding={"async"} width={"2880"} height={"1620"} sizes={"(min-width: 1280px) max((min(max((calc(min(max(100vw - 40px, 1px), 1320px) - 60px) - 60px) / 2, 1px), max((calc(min(max(100vw - 40px, 1px), 1320px) - 60px) - 60px) / 2, 1px) * 0.8) - 76px) / 2, 1px), (max-width: 991px) calc(calc(min(max(100vw - 40px, 1px), 1320px) - 40px) - 40px), (min-width: 992px) and (max-width: 1279px) max((min(max((calc(min(max(100vw - 40px, 1px), 1320px) - 40px) - 60px) / 2, 1px), max((calc(min(max(100vw - 40px, 1px), 1320px) - 40px) - 60px) / 2, 1px) * 0.8) - 76px) / 2, 1px)"} srcSet={"/assets/framerusercontent.com/images/EXuB611LXEfnItiH6clXM4bPg_qbdfb3cb8.jpg 512w,/assets/framerusercontent.com/images/EXuB611LXEfnItiH6clXM4bPg_q1cb5febc.jpg 1024w,/assets/framerusercontent.com/images/EXuB611LXEfnItiH6clXM4bPg_q5fcbabc4.jpg 2048w,/assets/framerusercontent.com/images/EXuB611LXEfnItiH6clXM4bPg.jpg 2880w"} src={"/assets/framerusercontent.com/images/EXuB611LXEfnItiH6clXM4bPg.jpg"} alt={"Video Banner"} style={{ display: "block", width: "100%", height: "100%", borderRadius: "inherit", cornerShape: "inherit", objectPosition: "center", objectFit: "cover" }} />
                              </div>
                            </div>
                          </div>
                        </div>
                      ...
                      <div className={"framer-NNZl9 framer-ovLcB framer-QlV1W framer-FUgh0 framer-80BYq framer-Suf9V framer-vkloki framer-v-vkloki"} data-framer-name={"Default"} style={{ width: "100%", willChange: "auto", opacity: "1", transform: "none" }}>
                        <div className={"framer-3nhjgs"} data-framer-name={"Text Content Wrapper"}>
                          ...
                          <div className={"framer-1lr7jys"} data-framer-name={"Video Content Wrapper Default"} style={{ backgroundColor: "var(--token-c7f7b4a7-d22a-4efb-a894-f6581be9e186, rgb(245, 245, 245))", borderBottomLeftRadius: "10px", borderBottomRightRadius: "10px", borderTopLeftRadius: "10px", borderTopRightRadius: "10px" }}>
                            ...
                            <div className={"framer-ddeqdn"} style={{ borderBottomLeftRadius: "4px", borderBottomRightRadius: "4px", borderTopLeftRadius: "4px", borderTopRightRadius: "4px" }}>
                              <div style={{ position: "absolute", borderRadius: "inherit", cornerShape: "inherit", top: "0", right: "0", bottom: "0", left: "0" }}>
                                <img decoding={"async"} width={"2880"} height={"1920"} sizes={"(min-width: 1280px) max((min(max((calc(min(max(100vw - 40px, 1px), 1320px) - 60px) - 60px) / 2, 1px), max((calc(min(max(100vw - 40px, 1px), 1320px) - 60px) - 60px) / 2, 1px) * 0.8) - 76px) / 2, 1px), (max-width: 991px) calc(calc(min(max(100vw - 40px, 1px), 1320px) - 40px) - 40px), (min-width: 992px) and (max-width: 1279px) max((min(max((calc(min(max(100vw - 40px, 1px), 1320px) - 40px) - 60px) / 2, 1px), max((calc(min(max(100vw - 40px, 1px), 1320px) - 40px) - 60px) / 2, 1px) * 0.8) - 76px) / 2, 1px)"} srcSet={"/assets/framerusercontent.com/images/MBfkpCm4RTegVZ4IYcaFGoBr3E_qbdfb3cb8.jpg 512w,/assets/framerusercontent.com/images/MBfkpCm4RTegVZ4IYcaFGoBr3E_q1cb5febc.jpg 1024w,/assets/framerusercontent.com/images/MBfkpCm4RTegVZ4IYcaFGoBr3E_q5fcbabc4.jpg 2048w,/assets/framerusercontent.com/images/MBfkpCm4RTegVZ4IYcaFGoBr3E.jpg 2880w"} src={"/assets/framerusercontent.com/images/MBfkpCm4RTegVZ4IYcaFGoBr3E.jpg"} alt={"Video Banner"} style={{ display: "block", width: "100%", height: "100%", borderRadius: "inherit", cornerShape: "inherit", objectPosition: "center", objectFit: "cover" }} />
                              </div>
                            </div>
                          </div>
                        </div>
                  ...
                  <div className={"ssr-variant"}>
                    <div className={"framer-15ybv27-container"} style={{ willChange: "auto", opacity: "1", transform: "none" }} />
                  </div>
                </div>
              </div>
            </section>
                  ...
                  <div className={"framer-jw2ae6-container"} style={{ willChange: "auto", opacity: "1", transform: "none" }}>
                    <div className={"framer-cNZMU framer-fN9WN framer-1f2mbrn framer-v-1f2mbrn"} data-framer-name={"Default"} style={{ width: "100%" }}>
                      ...
                      <div className={"framer-1pryn50"} data-framer-name={"Tarifs Cards Wrapper"}>
                        <div className={"framer-wbllb0-container"} style={{ willChange: "transform", opacity: "0.001", transform: "none" }}>
                          <div className={"framer-jIlUe framer-fN9WN framer-AZnGt framer-1eSXM framer-gbuwA framer-1cwxg2b framer-v-1cwxg2b"} data-border={"true"} data-framer-name={"Default"} style={{ "--border-bottom-width": "1px", "--border-color": "var(--token-8f4f0a97-886c-442e-9b68-fba0a777697e, rgb(229, 229, 229))", "--border-left-width": "1px", "--border-right-width": "1px", "--border-style": "solid", "--border-top-width": "1px", backgroundColor: "var(--token-5b150902-af7d-44cd-9806-3cf99a174e98, rgb(255, 255, 255))", width: "100%", borderBottomLeftRadius: "10px", borderBottomRightRadius: "10px", borderTopLeftRadius: "10px", borderTopRightRadius: "10px" }}>
                            <div className={"framer-nt5fcz"} data-framer-name={"LAbel Wrapper"} style={{ backgroundColor: "var(--token-ce7cac9b-68d2-43aa-b17a-9ff7b974f476, rgb(207, 231, 203))", borderBottomLeftRadius: "50px", borderBottomRightRadius: "50px", borderTopLeftRadius: "50px", borderTopRightRadius: "50px" }}>
                              <div className={"framer-16vg9cs"} data-framer-name={"Heading"} style={{ "--extracted-r6o4lv": "var(--token-fcc50f27-48bf-4381-8929-2fd53a7bb0e3, rgb(55, 97, 49))", "--framer-link-text-color": "rgb(0, 153, 255)", "--framer-link-text-decoration": "underline", transform: "none" }}>
                                <p className={"framer-text framer-styles-preset-1hcnkal"} data-styles-preset={"G4jBfKTMe"} style={{ "--framer-text-color": "var(--extracted-r6o4lv, var(--token-fcc50f27-48bf-4381-8929-2fd53a7bb0e3, rgb(55, 97, 49)))" }}>
                                  FORME
                                </p>
                              </div>
                            </div>
                            <div className={"framer-1kzcbcl"} data-framer-name={"Top Content Wrapper"}>
                              <div className={"framer-o4vb6l"} data-framer-name={"Price Wrapper"}>
                                <div className={"framer-10rsdus"} data-framer-name={"Price"} style={{ "--extracted-tcooor": "var(--token-97fc87a4-7472-48e0-baff-d882386fd651, rgb(0, 0, 0))", "--framer-link-text-color": "rgb(0, 153, 255)", "--framer-link-text-decoration": "underline", transform: "none" }}>
                                ...
                                <div className={"framer-1puz0xw"} data-framer-name={"Padding Bottom"}>
                                  <div className={"framer-1do8is4"} data-framer-name={"Price"} style={{ "--extracted-1w1cjl5": "var(--token-c3674009-0fe5-49c4-b319-05dd4e6ff53e, rgb(64, 64, 64))", "--framer-link-text-color": "rgb(0, 153, 255)", "--framer-link-text-decoration": "underline", transform: "none" }}>
                              ...
                              <div className={"framer-k9q449"} data-framer-name={"Body"} style={{ "--extracted-r6o4lv": "var(--token-c3674009-0fe5-49c4-b319-05dd4e6ff53e, rgb(64, 64, 64))", "--framer-link-text-color": "rgb(0, 153, 255)", "--framer-link-text-decoration": "underline", transform: "none" }}>
                            ...
                            <div className={"framer-ehqcyh"} data-border={"true"} data-framer-name={"Bottom Text Wrapper"} style={{ "--border-bottom-width": "1px", "--border-color": "var(--token-8f4f0a97-886c-442e-9b68-fba0a777697e, rgb(229, 229, 229))", "--border-left-width": "1px", "--border-right-width": "1px", "--border-style": "solid", "--border-top-width": "1px", backgroundColor: "var(--token-c7f7b4a7-d22a-4efb-a894-f6581be9e186, rgb(245, 245, 245))", borderBottomLeftRadius: "10px", borderBottomRightRadius: "10px" }}>
                              <div className={"framer-8ey6gv"} data-framer-name={"List Wrapper"}>
                                <div className={"framer-j2v4og-container"}>
                                  <div className={"framer-Pyzrn framer-gbuwA framer-1web91m framer-v-1web91m"} data-framer-name={"Default"} style={{ width: "100%" }}>
                                    <div className={"framer-123ipd2"} data-framer-name={"Icon"}>
                                      <div style={{ position: "absolute", borderRadius: "inherit", cornerShape: "inherit", top: "0", right: "0", bottom: "0", left: "0" }}>
                                        <img decoding={"async"} width={"24"} height={"25"} src={"/assets/framerusercontent.com/images/2sYRM8KAb54ZAad5lWhGRSg2I.svg"} alt={"Icon"} style={{ display: "block", width: "100%", height: "100%", borderRadius: "inherit", cornerShape: "inherit", objectPosition: "center", objectFit: "cover" }} />
                                      </div>
                                    </div>
                                    <div className={"framer-r6i663"} data-framer-name={"Body"} style={{ "--extracted-r6o4lv": "var(--token-97fc87a4-7472-48e0-baff-d882386fd651, rgb(0, 0, 0))", "--framer-link-text-color": "rgb(0, 153, 255)", "--framer-link-text-decoration": "underline", transform: "none" }}>
                                ...
                                <div className={"framer-17zzoll-container"}>
                                  <div className={"framer-Pyzrn framer-gbuwA framer-1web91m framer-v-1web91m"} data-framer-name={"Default"} style={{ width: "100%" }}>
                                    <div className={"framer-123ipd2"} data-framer-name={"Icon"}>
                                      <div style={{ position: "absolute", borderRadius: "inherit", cornerShape: "inherit", top: "0", right: "0", bottom: "0", left: "0" }}>
                                        <img decoding={"async"} width={"24"} height={"25"} src={"/assets/framerusercontent.com/images/2sYRM8KAb54ZAad5lWhGRSg2I.svg"} alt={"Icon"} style={{ display: "block", width: "100%", height: "100%", borderRadius: "inherit", cornerShape: "inherit", objectPosition: "center", objectFit: "cover" }} />
                                ...
                                <div className={"framer-1uo6x7i-container"}>
                                  <div className={"framer-Pyzrn framer-gbuwA framer-1web91m framer-v-1web91m"} data-framer-name={"Default"} style={{ width: "100%" }}>
                                    <div className={"framer-123ipd2"} data-framer-name={"Icon"}>
                                      <div style={{ position: "absolute", borderRadius: "inherit", cornerShape: "inherit", top: "0", right: "0", bottom: "0", left: "0" }}>
                                        <img decoding={"async"} width={"24"} height={"25"} src={"/assets/framerusercontent.com/images/2sYRM8KAb54ZAad5lWhGRSg2I.svg"} alt={"Icon"} style={{ display: "block", width: "100%", height: "100%", borderRadius: "inherit", cornerShape: "inherit", objectPosition: "center", objectFit: "cover" }} />
                                ...
                                <div className={"framer-4hcuhb-container"}>
                                  <div className={"framer-Pyzrn framer-gbuwA framer-1web91m framer-v-1web91m"} data-framer-name={"Default"} style={{ width: "100%" }}>
                                    <div className={"framer-123ipd2"} data-framer-name={"Icon"}>
                                      <div style={{ position: "absolute", borderRadius: "inherit", cornerShape: "inherit", top: "0", right: "0", bottom: "0", left: "0" }}>
                                        <img decoding={"async"} width={"24"} height={"25"} src={"/assets/framerusercontent.com/images/2sYRM8KAb54ZAad5lWhGRSg2I.svg"} alt={"Icon"} style={{ display: "block", width: "100%", height: "100%", borderRadius: "inherit", cornerShape: "inherit", objectPosition: "center", objectFit: "cover" }} />
                              ...
                              <div className={"framer-q3veeh-container"}>
                                <a className={"framer-mAcoc framer-X8adU framer-5jm32v framer-v-5jm32v framer-5eqsdb"} data-framer-name={"Default"} style={{ backdropFilter: "blur(0px)", backgroundColor: "var(--token-fcc50f27-48bf-4381-8929-2fd53a7bb0e3, rgb(55, 97, 49))", width: "100%", borderBottomLeftRadius: "70px", borderBottomRightRadius: "70px", borderTopLeftRadius: "70px", borderTopRightRadius: "70px" }} href={"/contact"}>
                        ...
                        <div className={"framer-1mzq3a2-container"} style={{ willChange: "transform", opacity: "0.001", transform: "none" }}>
                          <div className={"framer-jIlUe framer-fN9WN framer-AZnGt framer-1eSXM framer-gbuwA framer-1cwxg2b framer-v-1cwxg2b"} data-border={"true"} data-framer-name={"Default"} style={{ "--border-bottom-width": "1px", "--border-color": "var(--token-8f4f0a97-886c-442e-9b68-fba0a777697e, rgb(229, 229, 229))", "--border-left-width": "1px", "--border-right-width": "1px", "--border-style": "solid", "--border-top-width": "1px", backgroundColor: "var(--token-5b150902-af7d-44cd-9806-3cf99a174e98, rgb(255, 255, 255))", width: "100%", borderBottomLeftRadius: "10px", borderBottomRightRadius: "10px", borderTopLeftRadius: "10px", borderTopRightRadius: "10px" }}>
                            <div className={"framer-nt5fcz"} data-framer-name={"LAbel Wrapper"} style={{ backgroundColor: "var(--token-ce7cac9b-68d2-43aa-b17a-9ff7b974f476, rgb(207, 231, 203))", borderBottomLeftRadius: "50px", borderBottomRightRadius: "50px", borderTopLeftRadius: "50px", borderTopRightRadius: "50px" }}>
                              <div className={"framer-16vg9cs"} data-framer-name={"Heading"} style={{ "--extracted-r6o4lv": "var(--token-fcc50f27-48bf-4381-8929-2fd53a7bb0e3, rgb(55, 97, 49))", "--framer-link-text-color": "rgb(0, 153, 255)", "--framer-link-text-decoration": "underline", transform: "none" }}>
                                <p className={"framer-text framer-styles-preset-1hcnkal"} data-styles-preset={"G4jBfKTMe"} style={{ "--framer-text-color": "var(--extracted-r6o4lv, var(--token-fcc50f27-48bf-4381-8929-2fd53a7bb0e3, rgb(55, 97, 49)))" }}>
                        ...
                        <div className={"framer-2t980j-container"} style={{ willChange: "transform", opacity: "0.001", transform: "none" }}>
                          <div className={"framer-jIlUe framer-fN9WN framer-AZnGt framer-1eSXM framer-gbuwA framer-1cwxg2b framer-v-1cwxg2b"} data-border={"true"} data-framer-name={"Default"} style={{ "--border-bottom-width": "1px", "--border-color": "var(--token-8f4f0a97-886c-442e-9b68-fba0a777697e, rgb(229, 229, 229))", "--border-left-width": "1px", "--border-right-width": "1px", "--border-style": "solid", "--border-top-width": "1px", backgroundColor: "var(--token-5b150902-af7d-44cd-9806-3cf99a174e98, rgb(255, 255, 255))", width: "100%", borderBottomLeftRadius: "10px", borderBottomRightRadius: "10px", borderTopLeftRadius: "10px", borderTopRightRadius: "10px" }}>
                            <div className={"framer-nt5fcz"} data-framer-name={"LAbel Wrapper"} style={{ backgroundColor: "var(--token-ce7cac9b-68d2-43aa-b17a-9ff7b974f476, rgb(207, 231, 203))", borderBottomLeftRadius: "50px", borderBottomRightRadius: "50px", borderTopLeftRadius: "50px", borderTopRightRadius: "50px" }}>
                              <div className={"framer-16vg9cs"} data-framer-name={"Heading"} style={{ "--extracted-r6o4lv": "var(--token-fcc50f27-48bf-4381-8929-2fd53a7bb0e3, rgb(55, 97, 49))", "--framer-link-text-color": "rgb(0, 153, 255)", "--framer-link-text-decoration": "underline", transform: "none" }}>
                                <p className={"framer-text framer-styles-preset-1hcnkal"} data-styles-preset={"G4jBfKTMe"} style={{ "--framer-text-color": "var(--extracted-r6o4lv, var(--token-fcc50f27-48bf-4381-8929-2fd53a7bb0e3, rgb(55, 97, 49)))" }}>
                ...
                <div className={"framer-1kw3a1e"} data-framer-name={"Base Container"}>
                  ...
                  <div className={"framer-jw2ae6-container"} style={{ willChange: "auto", opacity: "1", transform: "none" }}>
                    <div className={"framer-cNZMU framer-fN9WN framer-1f2mbrn framer-v-1f2mbrn"} data-framer-name={"Default"} style={{ width: "100%" }}>
                      ...
                      <div className={"framer-1pryn50"} data-framer-name={"Tarifs Cards Wrapper"}>
                        <div className={"framer-wbllb0-container"} style={{ willChange: "transform", opacity: "0.001", transform: "none" }}>
                          <div className={"framer-jIlUe framer-fN9WN framer-AZnGt framer-1eSXM framer-gbuwA framer-1cwxg2b framer-v-nc7go"} data-border={"true"} data-framer-name={"Tablet"} style={{ "--border-bottom-width": "1px", "--border-color": "var(--token-8f4f0a97-886c-442e-9b68-fba0a777697e, rgb(229, 229, 229))", "--border-left-width": "1px", "--border-right-width": "1px", "--border-style": "solid", "--border-top-width": "1px", backgroundColor: "var(--token-5b150902-af7d-44cd-9806-3cf99a174e98, rgb(255, 255, 255))", width: "100%", borderBottomLeftRadius: "10px", borderBottomRightRadius: "10px", borderTopLeftRadius: "10px", borderTopRightRadius: "10px" }}>
                            <div className={"framer-nt5fcz"} data-framer-name={"LAbel Wrapper"} style={{ backgroundColor: "var(--token-ce7cac9b-68d2-43aa-b17a-9ff7b974f476, rgb(207, 231, 203))", borderBottomLeftRadius: "50px", borderBottomRightRadius: "50px", borderTopLeftRadius: "50px", borderTopRightRadius: "50px" }}>
                              <div className={"framer-16vg9cs"} data-framer-name={"Heading"} style={{ "--extracted-r6o4lv": "var(--token-fcc50f27-48bf-4381-8929-2fd53a7bb0e3, rgb(55, 97, 49))", "--framer-link-text-color": "rgb(0, 153, 255)", "--framer-link-text-decoration": "underline", transform: "none" }}>
                                <p className={"framer-text framer-styles-preset-1hcnkal"} data-styles-preset={"G4jBfKTMe"} style={{ "--framer-text-color": "var(--extracted-r6o4lv, var(--token-fcc50f27-48bf-4381-8929-2fd53a7bb0e3, rgb(55, 97, 49)))" }}>
                                  FORME
                ...
                <div className={"framer-1kw3a1e"} data-framer-name={"Base Container"}>
                  ...
                  <div className={"framer-jw2ae6-container"} style={{ willChange: "auto", opacity: "1", transform: "none" }}>
                    <div className={"framer-cNZMU framer-fN9WN framer-1f2mbrn framer-v-12d06jp"} data-framer-name={"Phone"} style={{ width: "100%" }}>
                      ...
                      <div className={"framer-1pryn50"} data-framer-name={"Tarifs Cards Wrapper"}>
                        <div className={"framer-wbllb0-container"} style={{ willChange: "transform", opacity: "0.001", transform: "none" }}>
                          <div className={"framer-jIlUe framer-fN9WN framer-AZnGt framer-1eSXM framer-gbuwA framer-1cwxg2b framer-v-19d5suc"} data-border={"true"} data-framer-name={"Phone"} style={{ "--border-bottom-width": "1px", "--border-color": "var(--token-8f4f0a97-886c-442e-9b68-fba0a777697e, rgb(229, 229, 229))", "--border-left-width": "1px", "--border-right-width": "1px", "--border-style": "solid", "--border-top-width": "1px", backgroundColor: "var(--token-5b150902-af7d-44cd-9806-3cf99a174e98, rgb(255, 255, 255))", width: "100%", borderBottomLeftRadius: "10px", borderBottomRightRadius: "10px", borderTopLeftRadius: "10px", borderTopRightRadius: "10px" }}>
                            <div className={"framer-nt5fcz"} data-framer-name={"LAbel Wrapper"} style={{ backgroundColor: "var(--token-ce7cac9b-68d2-43aa-b17a-9ff7b974f476, rgb(207, 231, 203))", borderBottomLeftRadius: "50px", borderBottomRightRadius: "50px", borderTopLeftRadius: "50px", borderTopRightRadius: "50px" }}>
                              <div className={"framer-16vg9cs"} data-framer-name={"Heading"} style={{ "--extracted-r6o4lv": "var(--token-fcc50f27-48bf-4381-8929-2fd53a7bb0e3, rgb(55, 97, 49))", "--framer-link-text-color": "rgb(0, 153, 255)", "--framer-link-text-decoration": "underline", transform: "none" }}>
                                <p className={"framer-text framer-styles-preset-1hcnkal"} data-styles-preset={"G4jBfKTMe"} style={{ "--framer-text-color": "var(--extracted-r6o4lv, var(--token-fcc50f27-48bf-4381-8929-2fd53a7bb0e3, rgb(55, 97, 49)))" }}>
                                  FORME
