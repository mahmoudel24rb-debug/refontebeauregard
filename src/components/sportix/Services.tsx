        ...
        <div className={"framer-9MYi8 framer-13v9dm1"} data-layout-template={"true"} style={{ minHeight: "100vh", width: "auto" }}>
          <div className={"framer-tJcDN framer-gbuwA framer-fN9WN framer-1b9gsd1"} style={{ minHeight: "100vh", width: "auto", display: "contents" }}>
            <div className={"framer-f65ckw-container"}>
              ...
              <div className={"ssr-variant hidden-1b9gsd1 hidden-2ydv6g"}>
              ...
              <div className={"ssr-variant hidden-1b9gsd1 hidden-oq9xoh"}>
            ...
            <section className={"framer-z4xr6w"} data-framer-name={"Inner Banner Section"}>
              ...
              <div className={"framer-1fefbwb"} data-framer-name={"Base Container"}>
                <div className={"framer-1m93o4t"} data-framer-name={"Title Wrapper"} style={{ willChange: "auto", opacity: "1", transform: "none" }}>
                  <div className={"ssr-variant hidden-oq9xoh hidden-2ydv6g"}>
                  ...
                  <div className={"ssr-variant hidden-1b9gsd1 hidden-2ydv6g"}>
                    <div className={"framer-10ux3ty"} data-framer-name={"Heading"} style={{ transform: "none" }}>
                      <h1 style={{ "--font-selector": "SW50ZXItQm9sZA==", "--framer-font-family": "&quot", "--framer-font-size": "48px", "--framer-font-weight": "700", "--framer-letter-spacing": "-1.92px", "--framer-line-height": "1.1em", "--framer-text-color": "var(--token-97fc87a4-7472-48e0-baff-d882386fd651, rgb(0, 0, 0))" }} className={"framer-text"}>
                        <span style={{ "--font-selector": "SW50ZXI=", "--framer-font-family": "&quot", "--framer-font-weight": "400" }} className={"framer-text"}>
                          Bien plus{" "}
                        </span>
                        que de simples cours.
            ...
            <section className={"framer-prucje"} data-framer-name={"Classes Section"}>
              <div className={"framer-4oxore"} data-framer-name={"Base Container"}>
                <div className={"framer-1vh77zd"} data-framer-name={"Title Wrapper"} style={{ willChange: "auto", opacity: "1", transform: "none" }}>
                ...
                <div className={"framer-1fypp9h"}>
                  <div className={"ssr-variant hidden-oq9xoh hidden-2ydv6g"}>
                    <div className={"framer-j1p7ba-container"} style={{ willChange: "auto", opacity: "1", transform: "none" }}>
                      <a className={"framer-nURDP framer-ovLcB framer-zUcIZ framer-16nx98q framer-v-1q1a2hz framer-maxoa4"} data-framer-name={"Card With Text Block"} style={{ width: "100%", borderBottomLeftRadius: "10px", borderBottomRightRadius: "10px", borderTopLeftRadius: "10px", borderTopRightRadius: "10px" }} href={"/services"}>
                        <div className={"framer-1m8bp3k"} data-framer-name={"Thumbnail"} style={{ borderBottomLeftRadius: "0px", borderBottomRightRadius: "0px", borderTopLeftRadius: "10px", borderTopRightRadius: "10px" }}>
                        ...
                        <div className={"framer-25lc8r"} data-framer-name={"Text Content Wrapper"} style={{ backgroundColor: "var(--token-c7f7b4a7-d22a-4efb-a894-f6581be9e186, rgb(245, 245, 245))", borderBottomLeftRadius: "10px", borderBottomRightRadius: "10px" }}>
                          <div className={"framer-4ec7ix"} data-framer-name={"Title"} style={{ "--extracted-a0htzi": "var(--token-5b150902-af7d-44cd-9806-3cf99a174e98, rgb(255, 255, 255))", "--extracted-1eung3n": "var(--token-97fc87a4-7472-48e0-baff-d882386fd651, rgb(0, 0, 0))", transform: "none" }}>
                        ...
                        <div className={"framer-lmih86"} data-framer-name={"Buttom Wrapper"}>
                          <div className={"framer-zzui6-container"} style={{ transform: "translateX(-50%)" }}>
                            <div className={"framer-m46Yg framer-irosbm framer-v-3a2y1"} data-framer-name={"Plus Button"} style={{ backgroundColor: "var(--token-ce7cac9b-68d2-43aa-b17a-9ff7b974f476, rgb(207, 231, 203))", borderBottomLeftRadius: "50%", borderBottomRightRadius: "50%", borderTopLeftRadius: "50%", borderTopRightRadius: "50%" }}>
                              <div className={"framer-xwgz5u"} data-framer-name={"Icon"} style={{ filter: "none", WebkitFilter: "none", transform: "rotate(-90deg)" }}>
                                <div style={{ position: "absolute", borderRadius: "inherit", cornerShape: "inherit", top: "0", right: "0", bottom: "0", left: "0" }}>
                                  <img decoding={"async"} width={"24"} height={"24"} src={"/assets/framerusercontent.com/images/pRm4iykOfHu8M7qRCsTN6ZPmkiQ.svg"} alt={"Icon"} style={{ display: "block", width: "100%", height: "100%", borderRadius: "inherit", cornerShape: "inherit", objectPosition: "center", objectFit: "cover" }} />
                                </div>
                              </div>
                            </div>
                          </div>
                  ...
                  <div className={"ssr-variant hidden-1b9gsd1 hidden-2ydv6g"}>
                    <div className={"framer-j1p7ba-container"} style={{ willChange: "auto", opacity: "1", transform: "none" }}>
                      <a className={"framer-nURDP framer-ovLcB framer-zUcIZ framer-16nx98q framer-v-1kw9zbc framer-maxoa4"} data-framer-name={"Phone Card With Text Block"} style={{ width: "100%", borderBottomLeftRadius: "10px", borderBottomRightRadius: "10px", borderTopLeftRadius: "10px", borderTopRightRadius: "10px" }} href={"/services"}>
                        <div className={"framer-1m8bp3k"} data-framer-name={"Thumbnail"} style={{ borderBottomLeftRadius: "0px", borderBottomRightRadius: "0px", borderTopLeftRadius: "10px", borderTopRightRadius: "10px" }}>
                          <div className={"framer-1o8anf"} data-framer-name={"BG Color"} style={{ backgroundColor: "var(--token-617eea88-08bd-4f71-aa3d-29b363f5895a, rgba(0, 0, 0, 0.3))" }} />
                          <div className={"framer-r69y6i"} data-framer-name={"Image"} style={{ transform: "none" }}>
                            <div style={{ position: "absolute", borderRadius: "inherit", cornerShape: "inherit", top: "0", right: "0", bottom: "0", left: "0" }}>
                        ...
                        <div className={"framer-lmih86"} data-framer-name={"Buttom Wrapper"}>
                          <div className={"framer-zzui6-container"} style={{ transform: "translateX(-50%)" }}>
                            <div className={"framer-m46Yg framer-irosbm framer-v-5ch02g"} data-framer-name={"Phone Plus Button"} style={{ backgroundColor: "var(--token-ce7cac9b-68d2-43aa-b17a-9ff7b974f476, rgb(207, 231, 203))", borderBottomLeftRadius: "50%", borderBottomRightRadius: "50%", borderTopLeftRadius: "50%", borderTopRightRadius: "50%" }}>
                              <div className={"framer-xwgz5u"} data-framer-name={"Icon"} style={{ filter: "none", WebkitFilter: "none", transform: "rotate(-90deg)" }}>
                                <div style={{ position: "absolute", borderRadius: "inherit", cornerShape: "inherit", top: "0", right: "0", bottom: "0", left: "0" }}>
                                  <img decoding={"async"} width={"24"} height={"24"} src={"/assets/framerusercontent.com/images/pRm4iykOfHu8M7qRCsTN6ZPmkiQ.svg"} alt={"Icon"} style={{ display: "block", width: "100%", height: "100%", borderRadius: "inherit", cornerShape: "inherit", objectPosition: "center", objectFit: "cover" }} />
                                </div>
                  ...
                  <div className={"ssr-variant hidden-1b9gsd1 hidden-oq9xoh"}>
                    <div className={"framer-j1p7ba-container"} style={{ willChange: "auto", opacity: "1", transform: "none" }}>
                      <a className={"framer-nURDP framer-ovLcB framer-zUcIZ framer-16nx98q framer-v-3ykh0v framer-maxoa4"} data-framer-name={"Tablet Card With Text Block"} style={{ width: "100%", borderBottomLeftRadius: "10px", borderBottomRightRadius: "10px", borderTopLeftRadius: "10px", borderTopRightRadius: "10px" }} href={"/services"}>
                        <div className={"framer-1m8bp3k"} data-framer-name={"Thumbnail"} style={{ borderBottomLeftRadius: "0px", borderBottomRightRadius: "0px", borderTopLeftRadius: "10px", borderTopRightRadius: "10px" }}>
                          <div className={"framer-1o8anf"} data-framer-name={"BG Color"} style={{ backgroundColor: "var(--token-617eea88-08bd-4f71-aa3d-29b363f5895a, rgba(0, 0, 0, 0.3))" }} />
                          <div className={"framer-r69y6i"} data-framer-name={"Image"} style={{ transform: "none" }}>
                            <div style={{ position: "absolute", borderRadius: "inherit", cornerShape: "inherit", top: "0", right: "0", bottom: "0", left: "0" }}>
                  ...
                  <div className={"framer-r07r1j"} data-framer-name={"Button Wrapper"}>
                    <div className={"framer-1exhes3-container"} style={{ willChange: "auto", opacity: "1", transform: "none" }} />
                  </div>
                </div>
              </div>
            </section>
