...
// Page « Services » (/services) — hub listant les 3 offres réelles du club.
// Restaurée (retour interne 29/07) : /services est une page finale en 200,
// ciblée par l'entrée « Cours » du menu. Les fiches restent sous /cours et
// /coaching (URLs françaises du retour client).
