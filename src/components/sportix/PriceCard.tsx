...
/* Carte de prix — markup EXACT du port Sportix (classes Framer conservées),
   paramétré. Sert pour les 5 formules mensuelles, les courtes durées et les tickets.
   Prêt pour Payload : remplacer le tableau de données par la collection `formules`. */
...
function Feature({ text }: { text: string }) {
  return (
    <div className={'framer-j2v4og-container'} style={{ opacity: '1' }}>
      <div
        className={'framer-Pyzrn framer-gbuwA framer-1web91m framer-v-1web91m'}
      ...
      >
        ...
        <div
          className={'framer-r6i663'}
          data-framer-name={'Body'}
          style={{ '--extracted-r6o4lv': 'var(--token-97fc87a4-7472-48e0-baff-d882386fd651, rgb(0, 0, 0))', transform: 'none', opacity: '1' } as React.CSSProperties}
        >
          <p
            className={'framer-text framer-styles-preset-1116k3j'}
            data-styles-preset={'CclRS3ecL'}
            style={{ '--framer-text-color': 'var(--extracted-r6o4lv, var(--token-97fc87a4-7472-48e0-baff-d882386fd651, rgb(0, 0, 0)))' } as React.CSSProperties}
          >
            {text}
          </p>
        </div>
...
export function PriceCard({ name, price, period, desc, features, href = '/contact', cta = "Je m'inscris" }: PriceCardData) {
  return (
    <div className={'framer-wbllb0-container'} style={{ willChange: 'transform', opacity: '1', transform: 'none' }}>
      <div
        className={'framer-jIlUe framer-fN9WN framer-AZnGt framer-1eSXM framer-gbuwA framer-1cwxg2b framer-v-1cwxg2b'}
        data-border={'true'}
        data-framer-name={'Default'}
        style={{ '--border-bottom-width': '1px', '--border-color': 'var(--token-8f4f0a97-886c-442e-9b68-fba0a777697e, rgb(229, 229, 229))', '--border-left-width': '1px', '--border-right-width': '1px', '--border-style': 'solid', '--border-top-width': '1px', backgroundColor: 'var(--token-5b150902-af7d-44cd-9806-3cf99a174e98, rgb(255, 255, 255))', width: '100%', borderRadius: '10px', opacity: '1' } as React.CSSProperties}
      >
        ...
        <div className={'framer-ehqcyh'} data-border={'true'} data-framer-name={'Bottom Text Wrapper'} style={{ '--border-bottom-width': '1px', '--border-color': 'var(--token-8f4f0a97-886c-442e-9b68-fba0a777697e, rgb(229, 229, 229))', '--border-left-width': '1px', '--border-right-width': '1px', '--border-style': 'solid', '--border-top-width': '1px', backgroundColor: 'var(--token-c7f7b4a7-d22a-4efb-a894-f6581be9e186, rgb(245, 245, 245))', borderBottomLeftRadius: '10px', borderBottomRightRadius: '10px', opacity: '1' } as React.CSSProperties}>
          ...
          <div className={'framer-q3veeh-container'} style={{ opacity: '1' }}>
            <a
              className={'framer-mAcoc framer-X8adU framer-5jm32v framer-v-5jm32v framer-5eqsdb'}
              data-framer-name={'Default'}
              style={{ backdropFilter: 'blur(0px)', backgroundColor: 'var(--token-fcc50f27-48bf-4381-8929-2fd53a7bb0e3, rgb(55, 97, 49))', width: '100%', borderRadius: '70px', opacity: '1' }}
              href={href}
            >
