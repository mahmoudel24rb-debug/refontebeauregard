          ...
          <div className={"framer-6Taye framer-gbuwA framer-fN9WN framer-QlV1W framer-FUgh0 framer-QZUlF framer-80BYq framer-1vvw60x"} style={{ minHeight: "100vh", width: "auto", display: "contents" }}>
            <div className={"framer-j5nkpw-container"}>
              <div className={"ssr-variant hidden-t8jtsi hidden-5dz366"}>
                <nav className={"framer-dN4YR framer-X8adU framer-SgNSh framer-DiAdc framer-12z1cd1 framer-v-12nfnzz"} data-framer-name={"Desktop Dark"} style={{ width: "100%", borderTopLeftRadius: "0px", borderTopRightRadius: "0px", opacity: "1" }}>
                  <div className={"framer-171f0ex"} data-framer-name={"Content Wrapper With BG"} style={{ backdropFilter: "none", backgroundColor: "var(--token-ce7cac9b-68d2-43aa-b17a-9ff7b974f476, rgb(207, 231, 203))", borderRadius: "100px", opacity: "1" }}>
            ...
            <section className={"framer-l92169"} data-framer-name={"Inner Banner Section"}>
              <div className={"framer-tilntx"} data-framer-name={"Base Container"}>
                <div className={"framer-p9hbuk"} data-framer-name={"Text  Content Wrapper"} style={{ willChange: "transform", opacity: "1", transform: "none" }}>
                  ...
                  <div className={"framer-tk96rp"} data-framer-name={"Links Wrapper"}>
                    <div className={"framer-jp3b11"} data-framer-name={"Link Item"}>
                      <div className={"framer-1c80p18"} data-framer-name={"Icon"}>
                        <div style={{ position: "absolute", borderRadius: "inherit", cornerShape: "inherit", top: "0", right: "0", bottom: "0", left: "0" }}>
                          <img decoding={"auto"} width={"16"} height={"16"} src={"/assets/framerusercontent.com/images/p60s4Chh4WLxLDNit4Bpc0GOPE.svg"} alt={"Icon"} style={{ display: "block", width: "100%", height: "100%", borderRadius: "inherit", cornerShape: "inherit", objectPosition: "center", objectFit: "contain" }} />
                        </div>
                      </div>
                    ...
                    <div className={"framer-t1hq7k"} data-framer-name={"Link Item"}>
                      <div className={"framer-v5pwxu"} data-framer-name={"Icon"}>
                        <div style={{ position: "absolute", borderRadius: "inherit", cornerShape: "inherit", top: "0", right: "0", bottom: "0", left: "0" }}>
                          <img decoding={"auto"} width={"16"} height={"16"} src={"/assets/framerusercontent.com/images/RWVB0EhtsXInajAfy2HZJIbo.svg"} alt={"Icon"} style={{ display: "block", width: "100%", height: "100%", borderRadius: "inherit", cornerShape: "inherit", objectPosition: "center", objectFit: "contain" }} />
                        </div>
                      </div>
                      <div className={"ssr-variant hidden-t8jtsi"}>
                    ...
                    <div className={"framer-uhazfp"} data-framer-name={"Link Item"}>
                      <div className={"framer-tc7k45"} data-framer-name={"Icon"}>
                        <div style={{ position: "absolute", borderRadius: "inherit", cornerShape: "inherit", top: "0", right: "0", bottom: "0", left: "0" }}>
                          <img decoding={"auto"} width={"20"} height={"16"} src={"/assets/framerusercontent.com/images/RIN0rNUU6aKX13Y3CyM6vo1Uw9g.svg"} alt={"Icon"} style={{ display: "block", width: "100%", height: "100%", borderRadius: "inherit", cornerShape: "inherit", objectPosition: "center", objectFit: "contain" }} />
                        </div>
                      </div>
                      <div className={"ssr-variant hidden-t8jtsi"}>
                ...
                <form className={"framer-acfs9k"} style={{ willChange: "transform", opacity: "1", transform: "none" }}>
                  ...
                  <input type={"text"} name={"website"} tabIndex={"-1"} autoComplete={"one-time-code"} aria-hidden={"true"} style={{ position: "absolute", transform: "scale(0)" }} data-1p-ignore={"true"} data-lpignore={"true"} data-form-type={"other"} data-bwignore={"true"} value={""} />
                  <input type={"text"} name={"company"} tabIndex={"-1"} autoComplete={"one-time-code"} aria-hidden={"true"} style={{ position: "absolute", transform: "scale(0)" }} data-1p-ignore={"true"} data-lpignore={"true"} data-form-type={"other"} data-bwignore={"true"} value={""} />
                  <input type={"text"} name={"message"} tabIndex={"-1"} autoComplete={"one-time-code"} aria-hidden={"true"} style={{ position: "absolute", transform: "scale(0)" }} data-1p-ignore={"true"} data-lpignore={"true"} data-form-type={"other"} data-bwignore={"true"} value={""} />
                  <input type={"text"} name={"subject"} tabIndex={"-1"} autoComplete={"one-time-code"} aria-hidden={"true"} style={{ position: "absolute", transform: "scale(0)" }} data-1p-ignore={"true"} data-lpignore={"true"} data-form-type={"other"} data-bwignore={"true"} value={""} />
                  <input type={"text"} name={"title"} tabIndex={"-1"} autoComplete={"one-time-code"} aria-hidden={"true"} style={{ position: "absolute", transform: "scale(0)" }} data-1p-ignore={"true"} data-lpignore={"true"} data-form-type={"other"} data-bwignore={"true"} value={""} />
                  <input type={"text"} name={"description"} tabIndex={"-1"} autoComplete={"one-time-code"} aria-hidden={"true"} style={{ position: "absolute", transform: "scale(0)" }} data-1p-ignore={"true"} data-lpignore={"true"} data-form-type={"other"} data-bwignore={"true"} value={""} />
                  <input type={"text"} name={"feedback"} tabIndex={"-1"} autoComplete={"one-time-code"} aria-hidden={"true"} style={{ position: "absolute", transform: "scale(0)" }} data-1p-ignore={"true"} data-lpignore={"true"} data-form-type={"other"} data-bwignore={"true"} value={""} />
                  <input type={"text"} name={"notes"} tabIndex={"-1"} autoComplete={"one-time-code"} aria-hidden={"true"} style={{ position: "absolute", transform: "scale(0)" }} data-1p-ignore={"true"} data-lpignore={"true"} data-form-type={"other"} data-bwignore={"true"} value={""} />
                  <input type={"text"} name={"details"} tabIndex={"-1"} autoComplete={"one-time-code"} aria-hidden={"true"} style={{ position: "absolute", transform: "scale(0)" }} data-1p-ignore={"true"} data-lpignore={"true"} data-form-type={"other"} data-bwignore={"true"} value={""} />
                  <input type={"text"} name={"remarks"} tabIndex={"-1"} autoComplete={"one-time-code"} aria-hidden={"true"} style={{ position: "absolute", transform: "scale(0)" }} data-1p-ignore={"true"} data-lpignore={"true"} data-form-type={"other"} data-bwignore={"true"} value={""} />
                  <input type={"text"} name={"comments"} tabIndex={"-1"} autoComplete={"one-time-code"} aria-hidden={"true"} style={{ position: "absolute", transform: "scale(0)" }} data-1p-ignore={"true"} data-lpignore={"true"} data-form-type={"other"} data-bwignore={"true"} value={""} />
                </form>
              </div>
            </section>
                ...
                <div className={"framer-k1r9s8"}>
                  <div className={"ssr-variant hidden-t8jtsi"}>
                    <div className={"ssr-variant"}>
                      <div className={"framer-1j1796b-container"} style={{ willChange: "transform", opacity: "1", transform: "none" }}>
