                      ...
                      <div className={"ssr-variant hidden-ugdvmg"}>
                        <div className={"framer-wvjDD framer-fN9WN framer-OI0K7 framer-1asic4e framer-v-1asic4e"} data-framer-name={"Default"}>
                          <div className={"framer-w3ryt"} data-framer-name={"Image"} style={{ borderBottomLeftRadius: "50%", borderBottomRightRadius: "50%", borderTopLeftRadius: "50%", borderTopRightRadius: "50%" }}>
                            <div style={{ position: "absolute", borderRadius: "inherit", cornerShape: "inherit", top: "0", right: "0", bottom: "0", left: "0" }}>
                              <img decoding={"async"} width={"1920"} height={"1275"} sizes={"(min-width: 1280px) 100vw, (min-width: 992px) and (max-width: 1279px) 100vw, (max-width: 991px) 100vw"} srcSet={"/assets/framerusercontent.com/images/7gYjRUgjlhaXumcRN2YT1Wr70_qbdfb3cb8.jpg 512w,/assets/framerusercontent.com/images/7gYjRUgjlhaXumcRN2YT1Wr70_q1cb5febc.jpg 1024w,/assets/framerusercontent.com/images/7gYjRUgjlhaXumcRN2YT1Wr70.jpg 1920w"} src={"/assets/framerusercontent.com/images/7gYjRUgjlhaXumcRN2YT1Wr70_qbdfb3cb8.jpg"} alt={null} style={{ display: "block", width: "100%", height: "100%", borderRadius: "inherit", cornerShape: "inherit", objectPosition: "46.7% 52.5%", objectFit: "cover" }} />
                            </div>
