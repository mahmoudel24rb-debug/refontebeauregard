          ...
          <div className={"framer-lRBlC framer-gbuwA framer-fN9WN framer-11tggmt"} style={{ minHeight: "100vh", width: "auto", display: "contents" }}>
            ...
            <section className={"framer-1kq4m4h"} data-framer-name={"Classes Section"}>
              <div className={"framer-1blkc1l"} data-framer-name={"Base Container"}>
                <div className={"framer-d9eh4p"} data-framer-name={"Top Content Wrapper"} style={{ willChange: "transform", opacity: "1", transform: "none" }}>
                    ...
                    <div className={"ssr-variant hidden-16q1mfx"}>
                      <div className={"framer-sxlwgz"} data-framer-name={"Heading"} style={{ transform: "none" }}>
                        <h2 style={{ "--font-selector": "SW50ZXItQm9sZA==", "--framer-font-family": "&quot", "--framer-font-size": "50px", "--framer-font-weight": "700", "--framer-letter-spacing": "-1.5px", "--framer-text-color": "var(--token-97fc87a4-7472-48e0-baff-d882386fd651, rgb(0, 0, 0))" }} className={"framer-text"}>
                          ...
                          redefining the way people experience
                          <span style={{ "--font-selector": "SW50ZXI=", "--framer-font-family": "&quot", "--framer-font-weight": "400" }} className={"framer-text"}>
                            {" "}sports.
                          </span>
                        </h2>
                ...
                <div className={"framer-18i9ozy"}>
                  <div className={"ssr-variant hidden-16q1mfx"}>
                    <div className={"ssr-variant"}>
                      <div className={"framer-ynjz3h-container"} style={{ willChange: "transform", opacity: "1", transform: "none" }}>
                            ...
                            <div className={"framer-zzui6-container"} style={{ opacity: "1" }}>
                              <div className={"framer-m46Yg framer-irosbm framer-v-irosbm"} data-framer-name={"Default"} style={{ backgroundColor: "var(--token-5b150902-af7d-44cd-9806-3cf99a174e98, rgb(255, 255, 255))", borderRadius: "50%", opacity: "1" }}>
                                <div className={"framer-xwgz5u"} data-framer-name={"Icon"} style={{ filter: "none", transform: "none", opacity: "1" }}>
                                  <div style={{ position: "absolute", borderRadius: "inherit", cornerShape: "inherit", top: "0", right: "0", bottom: "0", left: "0" }}>
                                    <img decoding={"auto"} loading={"lazy"} width={"24"} height={"24"} src={"/assets/framerusercontent.com/images/lTza15jEdDwI9K68idF0h1rBJNo.svg"} alt={"Icon"} style={{ display: "block", width: "100%", height: "100%", borderRadius: "inherit", cornerShape: "inherit", objectPosition: "center", objectFit: "cover" }} />
                                  </div>
                                </div>
                              </div>
                            </div>
                        ...
                        <div className={"framer-1kne1lv"} data-framer-name={"Title Wrapper"} style={{ opacity: "1" }}>
                          ...
                          <div className={"framer-1ewkqpr"} data-framer-name={"Body"} style={{ "--extracted-r6o4lv": "var(--token-c3674009-0fe5-49c4-b319-05dd4e6ff53e, rgb(64, 64, 64))", "--framer-link-text-color": "rgb(0, 153, 255)", "--framer-link-text-decoration": "underline", transform: "none", opacity: "1" }}>
                            <p className={"framer-text framer-styles-preset-1116k3j"} data-styles-preset={"CclRS3ecL"} style={{ "--framer-text-alignment": "left", "--framer-text-color": "var(--extracted-r6o4lv, var(--token-c3674009-0fe5-49c4-b319-05dd4e6ff53e, rgb(64, 64, 64)))" }}>
                              Hear from our members who have transformed their fitness, performance, and lifestyle with us!
                            </p>
                          </div>
                        </div>
                          ...
                          <div className={"framer-9nphq7-container"} style={{ transform: "rotate(180deg)", opacity: "1" }}>
                            <button className={"framer-NEM2f framer-c2t8k9 framer-v-1y76vsd"} data-framer-name={"Disabled"} data-highlight={"true"} data-reset={"button"} style={{ backgroundColor: "var(--token-ce7cac9b-68d2-43aa-b17a-9ff7b974f476, rgb(207, 231, 203))", height: "100%", width: "100%", borderBottomLeftRadius: "50%", borderBottomRightRadius: "50%", borderTopLeftRadius: "50%", borderTopRightRadius: "50%", opacity: "0.4" }} tabIndex={"0"}>
                              <div className={"framer-5ddiju"} data-framer-name={"Icon"} style={{ opacity: "1" }}>
                                <div style={{ position: "absolute", borderRadius: "inherit", cornerShape: "inherit", top: "0", right: "0", bottom: "0", left: "0" }}>
                                  <img decoding={"auto"} loading={"lazy"} width={"24"} height={"24"} src={"/assets/framerusercontent.com/images/husH6l0yBVPfc3Ir95YwAn8hww.svg"} alt={"Icon"} style={{ display: "block", width: "100%", height: "100%", borderRadius: "inherit", cornerShape: "inherit", objectPosition: "center", objectFit: "cover" }} />
                                </div>
                              </div>
                            </button>
                          </div>
                      ...
                      <div className={"framer-1gf08qd"} data-framer-name={"Testimonials Wrapper"} style={{ opacity: "1" }}>
                        <div className={"framer-1sa6cnf"} data-framer-name={"Testimonials Wrapp"} style={{ opacity: "1" }}>
                          <div className={"framer-k0ee4n-container"} style={{ opacity: "1" }}>
                            <div className={"framer-wnAi6 framer-zUcIZ framer-gbuwA framer-fN9WN framer-1ymzwmf framer-v-1ymzwmf"} data-framer-name={"Default"} style={{ backgroundColor: "var(--token-c7f7b4a7-d22a-4efb-a894-f6581be9e186, rgb(245, 245, 245))", width: "100%", borderRadius: "10px", opacity: "1" }}>
                              ...
                              <div className={"framer-1jzm1sk"} data-framer-name={"Text Content Wrapper"} style={{ opacity: "1" }}>
                                <div className={"framer-z5u0fp"} data-framer-name={"Heading"} style={{ "--extracted-1eung3n": "var(--token-97fc87a4-7472-48e0-baff-d882386fd651, rgb(0, 0, 0))", "--framer-link-text-color": "rgb(0, 153, 255)", "--framer-link-text-decoration": "underline", transform: "none", opacity: "1" }}>
                                  <h4 className={"framer-text framer-styles-preset-1f6c2a0"} data-styles-preset={"VAATHvepD"} style={{ "--framer-text-color": "var(--extracted-1eung3n, var(--token-97fc87a4-7472-48e0-baff-d882386fd651, rgb(0, 0, 0)))" }}>
                                    “A game-changer for my training!”
                                  </h4>
                                </div>
                            ...
                            <div className={"framer-wnAi6 framer-zUcIZ framer-gbuwA framer-fN9WN framer-1ymzwmf framer-v-1ymzwmf"} data-framer-name={"Default"} style={{ backgroundColor: "var(--token-c7f7b4a7-d22a-4efb-a894-f6581be9e186, rgb(245, 245, 245))", width: "100%", borderRadius: "10px", opacity: "1" }}>
                              ...
                              <div className={"framer-1jzm1sk"} data-framer-name={"Text Content Wrapper"} style={{ opacity: "1" }}>
                                ...
                                <div className={"framer-lpsxj0"} data-framer-name={"Testimonials Wrapper"} style={{ opacity: "1" }}>
                                  <div className={"framer-1akfa26"} data-framer-name={"Body"} style={{ "--extracted-r6o4lv": "var(--token-c3674009-0fe5-49c4-b319-05dd4e6ff53e, rgb(64, 64, 64))", "--framer-link-text-color": "rgb(0, 153, 255)", "--framer-link-text-decoration": "underline", transform: "none", opacity: "1" }}>
                                    <p className={"framer-text framer-styles-preset-1116k3j"} data-styles-preset={"CclRS3ecL"} style={{ "--framer-text-color": "var(--extracted-r6o4lv, var(--token-c3674009-0fe5-49c4-b319-05dd4e6ff53e, rgb(64, 64, 64)))" }}>
                                      “Athletic has everything I need—expert coaches, top-notch equipment, and an amazing atmosphere. I feel stronger, healthier, and more motivated than ever!”
                                    </p>
                                  </div>
                                  <div className={"framer-1egm2r7"} data-framer-name={"Body"} style={{ "--extracted-r6o4lv": "var(--token-97fc87a4-7472-48e0-baff-d882386fd651, rgb(0, 0, 0))", "--framer-link-text-color": "rgb(0, 153, 255)", "--framer-link-text-decoration": "underline", transform: "none", opacity: "1" }}>
                                    <p className={"framer-text framer-styles-preset-1hcnkal"} data-styles-preset={"G4jBfKTMe"} style={{ "--framer-text-color": "var(--extracted-r6o4lv, var(--token-97fc87a4-7472-48e0-baff-d882386fd651, rgb(0, 0, 0)))" }}>
                            ...
                            <div className={"framer-wnAi6 framer-zUcIZ framer-gbuwA framer-fN9WN framer-1ymzwmf framer-v-1ymzwmf"} data-framer-name={"Default"} style={{ backgroundColor: "var(--token-c7f7b4a7-d22a-4efb-a894-f6581be9e186, rgb(245, 245, 245))", width: "100%", borderRadius: "10px", opacity: "1" }}>
                              ...
                              <div className={"framer-1jzm1sk"} data-framer-name={"Text Content Wrapper"} style={{ opacity: "1" }}>
                                ...
                                <div className={"framer-lpsxj0"} data-framer-name={"Testimonials Wrapper"} style={{ opacity: "1" }}>
                                  <div className={"framer-1akfa26"} data-framer-name={"Body"} style={{ "--extracted-r6o4lv": "var(--token-c3674009-0fe5-49c4-b319-05dd4e6ff53e, rgb(64, 64, 64))", "--framer-link-text-color": "rgb(0, 153, 255)", "--framer-link-text-decoration": "underline", transform: "none", opacity: "1" }}>
                                    <p className={"framer-text framer-styles-preset-1116k3j"} data-styles-preset={"CclRS3ecL"} style={{ "--framer-text-color": "var(--extracted-r6o4lv, var(--token-c3674009-0fe5-49c4-b319-05dd4e6ff53e, rgb(64, 64, 64)))" }}>
                                      “I love the community at Athletic. The group classes push me beyond my limits, and I’ve made great friends along the way!”
                                    </p>
                                  </div>
                                  <div className={"framer-1egm2r7"} data-framer-name={"Body"} style={{ "--extracted-r6o4lv": "var(--token-97fc87a4-7472-48e0-baff-d882386fd651, rgb(0, 0, 0))", "--framer-link-text-color": "rgb(0, 153, 255)", "--framer-link-text-decoration": "underline", transform: "none", opacity: "1" }}>
                                    <p className={"framer-text framer-styles-preset-1hcnkal"} data-styles-preset={"G4jBfKTMe"} style={{ "--framer-text-color": "var(--extracted-r6o4lv, var(--token-97fc87a4-7472-48e0-baff-d882386fd651, rgb(0, 0, 0)))" }}>
