...
export const metadata = { title: "Nos cours collectifs", description: "40 cours collectifs par semaine : yoga, pilates, boxe, cross training, HYROX, école du dos et plus encore." }
